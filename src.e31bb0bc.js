...
//   });
// });
},{"gsap/gsap-core":"../node_modules/gsap/gsap-core.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","@barba/core":"../node_modules/@barba/core/dist/barba.umd.js"}],"js/testimonial.js":[function(require,module,exports) {
"use strict";
...
function testimonials() {
  ...
  var rightBtn = document.querySelector('.slider__btn--right');
  var leftBtn = document.querySelector('.slider__btn--left');
  ...
  function moveSlide(slide) {
    slides.forEach(function (s, index) {
      s.style.transform = "translateX(".concat(100 * (index - slide), "%)");
    });
  }

  function nextSlide() {
    if (currentSlide === maxSlide - 1) currentSlide = 0;else currentSlide++;
    moveSlide(currentSlide);
    dotActive(currentSlide);
  }

  function prevSlide() {
    if (currentSlide === 0) currentSlide = maxSlide - 1;else currentSlide--;
    moveSlide(currentSlide);
    dotActive(currentSlide);
  } // initialize
...
},{"@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js"}],"../node_modules/gsap/CSSPlugin.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/transitionAnim.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onceAnimation = exports.leaveAnimation = exports.enterAnimation = void 0;

var _gsap = _interopRequireDefault(require("gsap"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var onceAnimation = function onceAnimation() {
  // return gsap.fromTo('.swipe', {x: '0%'}, { x: '-100%', stagger: 0.5, duration: 1 });
  var tl = _gsap.default.timeline(); // tl.to('ul.transition li', { duration: 0.5, scaleY: 1, transformOrigin: 'bottom left', stagger: 0.2 });
...
exports.onceAnimation = onceAnimation;

var enterAnimation = function enterAnimation(container, async) {
  // let done = this.async();
  window.scrollTo(0, 0);
...
var leaveAnimation = function leaveAnimation(container, async) {
  // let done = this.async();
  var tl = _gsap.default.timeline({
    defaults: {
      ease: "power2.inOut"
...
exports.leaveAnimation = leaveAnimation;
},{"gsap":"../node_modules/gsap/index.js"}],"js/tilesAnimation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showTiles = showTiles;
...
function showTiles() {
  ...
  _gsap.default.utils.toArray('.tiles').forEach(function (section, index) {
    var tilesSection = section.querySelector('.tiles__line');

    var _ref = index % 2 ? ['100%', (tilesSection.scrollWidth - section.offsetWidth) * -1] : [tilesSection.scrollWidth * -1, 0],
        _ref2 = (0, _slicedToArray2.default)(_ref, 2),
        x = _ref2[0],
        xEnd = _ref2[1];

    t1 = _gsap.default.fromTo(tilesSection, {
      x: x
    }, {
      x: xEnd
    });
    tilesScene = new ScrollMagic.Scene({
      ...
      duration: 1000,
      offset: -250
    }).setTween(t1) // .addIndicators({colorStart: 'white', colorTrigger: 'white', name: 'tiles'})
    .addTo(controller);
  });
}
},{"@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js","gsap":"../node_modules/gsap/index.js"}],"js/fromValidation.js":[function(require,module,exports) {
"use strict";
...
},{"./products":"js/products.js"}],"js/cart.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/fixedNavBar.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js"}],"js/calender.js":[function(require,module,exports) {
"use strict";
...
var _testimonial = require("./js/testimonial");

var _revealSections = require("./js/revealSections");

var _transitionAnim = require("./js/transitionAnim");

var _tilesAnimation = require("./js/tilesAnimation");
...
var header = document.querySelector('#home');
var navBar = document.getElementById('nav'); // Navigation bar
...
_core.default.init({
  views: [{
    ...
    beforeEnter: function beforeEnter() {
      (0, _tilesAnimation.showTiles)();
      (0, _testimonial.testimonials)();
      (0, _revealSections.revealSections)(); //  ui.setupAPP();
      // productDisplay()
    },
  ...
  transitions: [{
    ...
    once: function once(_ref) {
      var current = _ref.current,
          next = _ref.next;
      (0, _transitionAnim.onceAnimation)();
    },
    leave: function leave(_ref2) {
      var current = _ref2.current,
          next = _ref2.next;
      var done = this.async();
      (0, _transitionAnim.leaveAnimation)(current.container, done);
    },
    enter: function enter(_ref3) {
      var current = _ref3.current,
          next = _ref3.next;
      var done = this.async();
      (0, _transitionAnim.enterAnimation)(next.container, done);
    }
  } // {
...
/****************** *******************/
},{"./utils":"utils.js","@barba/core":"../node_modules/@barba/core/dist/barba.umd.js","./js/testimonial":"js/testimonial.js","./js/revealSections":"js/revealSections.js","./js/transitionAnim":"js/transitionAnim.js","./js/tilesAnimation":"js/tilesAnimation.js","./js/fromValidation":"js/fromValidation.js","./js/products":"js/products.js","./js/ticketsDisplay":"js/ticketsDisplay.js","./js/cart":"js/cart.js","./js/contactModal":"js/contactModal.js","./js/fixedNavBar":"js/fixedNavBar.js","./js/calender":"js/calender.js","gsap/gsap-core":"../node_modules/gsap/gsap-core.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
