...
exports.labelAnimation = exports.escCloseModal = exports.closeModal = exports.openModal = void 0;
...
var escCloseModal = function escCloseModal(e) {
  if (e.key === 'Escape' && !modal.classList.contains('hidden')) {
    closeModal();
  }
};

exports.escCloseModal = escCloseModal;

var labelAnimation = function labelAnimation() {
  labels.forEach(function (label) {
    var innerText = label.innerHTML.split('').map(function (letter, index) {
...
exports.labelAnimation = labelAnimation;
...
var cartBtnMobile = document.querySelector('.cart-btn--mobile');
var cartBtnDesk = document.querySelector('.cart-btn--desk');
...
function showCart() {
  ...
  var cartOverlay = document.querySelector('.cart-overlay');
  cartOverlay.classList.add('transparentBcg'); // cartDOM.classList.add('show-cart');
...
function closeCart() {
  var cartDOM = document.querySelector('.cart');
  var cartOverlay = document.querySelector('.cart-overlay');
  cartOverlay.classList.remove('transparentBcg'); // cartDOM.classList.add('show-cart');
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/products.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Storage = exports.ui = exports.products = void 0;
...
var cartDOM = document.querySelector('.cart');
var cartOverlay = document.querySelector('.cart-overlay');
var clearCartBtn = document.querySelector('.clear-cart'); // Getting products
...
var Products = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Products, [{
    key: "fetchProducts",
    value: function () {
      var _fetchProducts = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var response, _products;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _axios.default.get('products.json');

              case 3:
                response = _context.sent;
                _products = response.data.items;
                _products = _products.map(function (item) {
...
var UI = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(UI, [{
    ...
    value: function displayProducts(products) {
      var productDOM = document.querySelector('.products-center');
      var result = '';
      products.forEach(function (product) {
        result += "\n    <article class=\"product\">\n          <div class=\"img-container\">\n            <img src=".concat(product.image, " alt=\"class 1\" class=\"product-img\">\n            <button class=\"bag-btn\" data-id=").concat(product.id, ">\n              <i class=\"fas fa-shopping-cart\"></i>\n              add to cart\n            </button>\n          </div>\n          <h3>").concat(product.title, "</h3>\n          <h4>\xA3").concat(product.price, "</h4>\n    </article>\n    ");
      });
    ...
    value: function getBagButtons() {
      ...
      var buttons = (0, _toConsumableArray2.default)(document.querySelectorAll('.bag-btn')); //spread operator to make NodeList into array.
      ...
      buttons.forEach(function (button) {
        ...
        button.addEventListener('click', function (e) {
          ...
          e.target.disabled = true; //  get product from local storage

          var cartItem = _objectSpread(_objectSpread({}, Storage.getProduct(id)), {}, {
            amount: 1
          }); //amount for total no of item in cart usage
          // add product to cart 


          cart = [].concat((0, _toConsumableArray2.default)(cart), [cartItem]); //Add cartItem along with existing item in cart

          Storage.saveCart(cart); // set cart values

          _this.setCartValues(cart); // Display cart items


          _this.addCartItem(cartItem); // Show cart
    ...
    value: function cartLogic() {
      ...
      cartContent.addEventListener('click', function (e) {
        if (e.target.classList.contains('remove-item')) {
          ...
          var reduceAmount = e.target;
          var _id2 = reduceAmount.dataset.id;
          ...
          if (_tempItem.amount > 0) {
            ...
            reduceAmount.previousElementSibling.innerText = _tempItem.amount;
          } else {
            cartContent.removeChild(reduceAmount.closest('.cart-item'));
...
},{"@babel/runtime/helpers/defineProperty":"../node_modules/@babel/runtime/helpers/defineProperty.js","@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/classCallCheck":"../node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"../node_modules/@babel/runtime/helpers/createClass.js","axios":"../node_modules/axios/index.js"}],"js/ticketsDisplay.js":[function(require,module,exports) {
"use strict";
...
function productDisplay() {
  _products.products.fetchProducts().then(function (products) {
    _products.ui.displayProducts(products);

    _products.Storage.saveProducts(products); // ui.setupAPP()

  }).then(function () {
    _products.ui.getBagButtons();
  });
}
},{"./products":"js/products.js"}],"js/fromValidation.js":[function(require,module,exports) {
"use strict";
...
function formValidation() {
  ...
  var phone = document.querySelector('#phone'); // Error input

  function showError(input, message) {
    var inputContainer = input.parentElement;
    inputContainer.classList.add('error');
    var small = inputContainer.querySelector('small');
    small.innerText = message; // inputContainer.className = 'input-container error';
  } // email validity
  ...
  function checkRequired(inputArray) {
    ...
    inputArray.forEach(function (input) {
      if (input.value.trim() === '') {
        showError(input, "".concat(getField(input), " is required"));
        isRequired = true;
      } else {
        showSuccess(input);
      }
...
var navBar = document.getElementById('nav'); // Fixed navBar 
...
var stickyNav = function stickyNav(entries) {
  ...
  if (!entry.isIntersecting) navBar.classList.add("fixed-nav");else navBar.classList.remove("fixed-nav");
};
...
exports.obsOptions = obsOptions;

var navHover = function navHover(e, opacity) {
  if (e.target.classList.contains('nav__link')) {
    var link = e.target;
    var siblings = link.closest('.links').querySelectorAll('.nav__link');
...
exports.navHover = navHover;
},{"@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
exports.navToggleBar = navToggleBar;
exports.fixedNavBar = fixedNavBar;
exports.navAnim = navAnim;
exports.pageTransition = pageTransition;
exports.cursorHover = exports.cursor = void 0;
...
function pageTransition() {// barba.init({
  //   views: [
  //     {
  //       namespace: "home",
  //       beforeEnter() {
...
//   });
// });
},{"gsap/gsap-core":"../node_modules/gsap/gsap-core.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","@barba/core":"../node_modules/@barba/core/dist/barba.umd.js"}],"tickets.js":[function(require,module,exports) {
'use strict';

var _contactModal = require("./js/contactModal");

var _cart = require("./js/cart");

var _ticketsDisplay = require("./js/ticketsDisplay");

var _fromValidation = require("./js/fromValidation");

var _products = require("./js/products");

var _fixedNavBar = require("./js/fixedNavBar");

var _utils = require("./utils");

var app = function app() {
  (0, _utils.footerDate)(); // Animating nav slide

  (0, _utils.navAnim)(); //Links slide animation

  (0, _fromValidation.formValidation)();

  _products.ui.setupAPP();

  _products.ui.cartLogic();

  (0, _ticketsDisplay.productDisplay)();
};

app(); // cursor animation

window.addEventListener("mousemove", _utils.cursor);
/****************** Shopping Cart *******************/

var cartBtnMobile = document.querySelector('.cart-btn--mobile');
var cartBtnDesk = document.querySelector('.cart-btn--desk');
var closeCartBtn = document.querySelector('.close-cart');
cartBtnDesk.addEventListener('click', _cart.showCart);
cartBtnMobile.addEventListener('click', _cart.showCart);
closeCartBtn.addEventListener('click', _cart.closeCart);
/****************** Shopping Cart *******************/
...
var btnsOpenModal = document.querySelector('.btn--show-modal');
btnsOpenModal.addEventListener('click', _contactModal.openModal);
btnCloseModal.addEventListener('click', _contactModal.closeModal);
overlay.addEventListener('click', _contactModal.closeModal);
document.addEventListener('keydown', _contactModal.escCloseModal); // label animation

(0, _contactModal.labelAnimation)();
/****************** Contact Model *******************/
...
navToggle.addEventListener('click', _utils.navToggleBar); // Mobile view nav toggle
// Fixed navBar 

var links = document.querySelector('.links');
var header = document.querySelector('#home');
var navBar = document.getElementById('nav'); // Fixed NavBar Intersection Observer

var headerObserver = new IntersectionObserver(_fixedNavBar.stickyNav, _fixedNavBar.obsOptions);
headerObserver.observe(header); // Menu fade out Animation

links.addEventListener('mouseover', function (e) {
  return (0, _fixedNavBar.navHover)(e, 0.5);
});
links.addEventListener('mouseout', function (e) {
  return (0, _fixedNavBar.navHover)(e, 1);
});
/****************** Nav Bar *******************/
},{"./js/contactModal":"js/contactModal.js","./js/cart":"js/cart.js","./js/ticketsDisplay":"js/ticketsDisplay.js","./js/fromValidation":"js/fromValidation.js","./js/products":"js/products.js","./js/fixedNavBar":"js/fixedNavBar.js","./utils":"utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63604" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tickets.js"], null)
//# sourceMappingURL=/tickets.e45f8707.js.map