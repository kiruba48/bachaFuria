...
!function (e, t) {
    ...
    printDocToString: function printDocToString(e, t) {
      ...
      for (; 0 !== o.length;) {
        ...
        if ("string" == typeof _c2) {
          ...
          case "indent":
            o.push([Jt(_e8, t), _l3, _c2.contents]);
            break;

          case "align":
            o.push([Gt(_e8, _c2.n, t), _l3, _c2.contents]);
            break;
          ...
          case "group":
            switch (_l3) {
              case 2:
                if (!i) {
                  o.push([_e8, _c2.break ? 1 : 2, _c2.contents]);
                  break;
                }
              ...
              case 1:
                {
                  ...
                  var _r8 = [_e8, 2, _c2.contents],
                      _a3 = n - u;

                  if (!_c2.break && Yt(_r8, o, _a3, t)) o.push(_r8);else if (_c2.expandedStates) {
                    var _n9 = _c2.expandedStates[_c2.expandedStates.length - 1];
                    ...
                    for (var _r9 = 1; _r9 < _c2.expandedStates.length + 1; _r9++) {
                      ...
                      {
                        var _n10 = [_e8, 2, _c2.expandedStates[_r9]];
                  ...
                  } else o.push([_e8, 1, _c2.contents]);
                  break;
                }
            }
          ...
          case "fill":
            {
              ...
              var _g2 = [_e8, _l3, $t(_a4)],
                  _D2 = _a4[0];
              Yt([_e8, 2, Wt([_i2, _s3, _D2])], [], _r10, t, !0) ? (o.push(_g2), o.push(_h2), o.push(_p2)) : _f2 ? (o.push(_g2), o.push(_m2), o.push(_p2)) : (o.push(_g2), o.push(_m2), o.push(_d2));
              break;
            }

          case "if-break":
            {
              var _t7 = _c2.groupId ? zt[_c2.groupId] : _l3;

              1 === _t7 && _c2.breakContents && o.push([_e8, _l3, _c2.breakContents]), 2 === _t7 && _c2.flatContents && o.push([_e8, _l3, _c2.flatContents]);
              break;
            }

          case "line-suffix":
            s.push([_e8, _l3, _c2.contents]);
            break;

          case "line-suffix-boundary":
            s.length > 0 && o.push([_e8, _l3, {
              type: "line",
              hard: !0
            }]);
            break;
          ...
          case "line":
            switch (_l3) {
              ...
              case 1:
                if (s.length) {
                  o.push([_e8, _l3, _c2]), o.push.apply(o, _toConsumableArray(s.reverse())), s = [];
                  break;
                }
      ...
      if (-1 !== l) {
        var _e10 = a.indexOf(Ut.placeholder, l + 1),
            ...
            _n11 = a.slice(l + 1, _e10).join("");

        return {
          formatted: _t8 + _n11 + a.slice(_e10 + 1).join(""),
  ...
  function nn(e, t) {
    ...
    if ("if-break" === e.type) {
      var _n13 = e.breakContents && nn(e.breakContents, t),
          _r11 = e.flatContents && nn(e.flatContents, t);
  ...
  function cn(e) {
    if ("concat" === e.type) {
      ...
      for (var _n15 = 0; _n15 < e.parts.length; ++_n15) {
        ...
        if ("string" != typeof _r12 && "concat" === _r12.type) _t12.push.apply(_t12, _toConsumableArray(cn(_r12).parts));else {
          var _e13 = cn(_r12);
    ...
    return "if-break" === e.type ? Object.assign({}, e, {
      breakContents: null != e.breakContents ? cn(e.breakContents) : null,
      flatContents: null != e.flatContents ? cn(e.flatContents) : null
    }) : "group" === e.type ? Object.assign({}, e, {
      contents: cn(e.contents),
      expandedStates: e.expandedStates ? e.expandedStates.map(cn) : e.expandedStates
  ...
  function pn(e) {
    ...
    if ("concat" === e.type) return "[" + e.parts.map(pn).join(", ") + "]";
    if ("indent" === e.type) return "indent(" + pn(e.contents) + ")";
    if ("align" === e.type) return e.n === -1 / 0 ? "dedentToRoot(" + pn(e.contents) + ")" : e.n < 0 ? "dedent(" + pn(e.contents) + ")" : "root" === e.n.type ? "markAsRoot(" + pn(e.contents) + ")" : "align(" + JSON.stringify(e.n) + ", " + pn(e.contents) + ")";
    if ("if-break" === e.type) return "ifBreak(" + pn(e.breakContents) + (e.flatContents ? ", " + pn(e.flatContents) : "") + ")";
    if ("group" === e.type) return e.expandedStates ? "conditionalGroup([" + e.expandedStates.map(pn).join(",") + "])" : (e.break ? "wrappedGroup" : "group") + "(" + pn(e.contents) + ")";
    if ("fill" === e.type) return "fill(" + e.parts.map(pn).join(", ") + ")";
    if ("line-suffix" === e.type) return "lineSuffix(" + pn(e.contents) + ")";
  ...
  function Tn(e, t) {
    if (Bn() < t) throw new RangeError("Invalid typed array length");
    return kn.TYPED_ARRAY_SUPPORT ? (e = new Uint8Array(t)).__proto__ = kn.prototype : (null === e && (e = new kn(t)), e.length = t), e;
  }

  function kn(e, t, n) {
    if (!(kn.TYPED_ARRAY_SUPPORT || this instanceof kn)) return new kn(e, t, n);
  ...
  function Nn(e, t, n, r) {
    ...
    return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer ? function (e, t, n, r) {
      ...
      kn.TYPED_ARRAY_SUPPORT ? (e = t).__proto__ = kn.prototype : e = _n(e, t);
      return e;
    }(e, t, n, r) : "string" == typeof t ? function (e, t, n) {
      "string" == typeof n && "" !== n || (n = "utf8");
      if (!kn.isEncoding(n)) throw new TypeError('"encoding" must be a valid string encoding');
      var r = 0 | Mn(t, n),
          u = (e = Tn(e, r)).write(t, n);
      u !== r && (e = e.slice(0, u));
      return e;
    }(e, t, n) : function (e, t) {
      if (jn(t)) {
        var n = 0 | In(t.length);
        return 0 === (e = Tn(e, n)).length || t.copy(e, 0, 0, n), e;
      }

      if (t) {
        if ("undefined" != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer || "length" in t) return "number" != typeof t.length || (r = t.length) != r ? Tn(e, 0) : _n(e, t);
        if ("Buffer" === t.type && wn(t.data)) return _n(e, t.data);
      }
  ...
  function _n(e, t) {
    var n = t.length < 0 ? 0 : 0 | In(t.length);
    e = Tn(e, n);
  ...
  function In(e) {
    if (e >= Bn()) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + Bn().toString(16) + " bytes");
    return 0 | e;
  }
  ...
  function qn(e, t, n, r, u) {
    ...
    if ("string" == typeof t && (t = kn.from(t, r)), jn(t)) return 0 === t.length ? -1 : Vn(e, t, n, r, u);
    if ("number" == typeof t) return t &= 255, kn.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? u ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : Vn(e, [t], n, r, u);
  ...
  kn.TYPED_ARRAY_SUPPORT = void 0 === me.TYPED_ARRAY_SUPPORT || me.TYPED_ARRAY_SUPPORT, kn.poolSize = 8192, kn._augment = function (e) {
    ...
    if (!wn(e)) throw new TypeError('"list" argument must be an Array of Buffers');
    if (0 === e.length) return kn.alloc(0);
    var n;
    ...
    for (n = 0; n < e.length; ++n) {
      var o = e[n];
      if (!jn(o)) throw new TypeError('"list" argument must be an Array of Buffers');
    ...
    var e = 0 | this.length;
    return 0 === e ? "" : 0 === arguments.length ? Xn(this, 0, e) : Ln.apply(this, arguments);
  }, kn.prototype.equals = function (e) {
    if (!jn(e)) throw new TypeError("Argument must be a Buffer");
    return this === e || 0 === kn.compare(this, e);
  ...
  function tr(e, t, n, r, u, o) {
    if (!jn(e)) throw new TypeError('"buffer" argument must be a Buffer instance');
  ...
  kn.prototype.slice = function (e, t) {
    var n,
        r = this.length;
    if ((e = ~~e) < 0 ? (e += r) < 0 && (e = 0) : e > r && (e = r), (t = void 0 === t ? r : ~~t) < 0 ? (t += r) < 0 && (t = 0) : t > r && (t = r), t < e && (t = e), kn.TYPED_ARRAY_SUPPORT) (n = this.subarray(e, t)).__proto__ = kn.prototype;else {
      var u = t - e;
      n = new kn(u, void 0);
    ...
    (e = +e, t |= 0, n |= 0, r) || tr(this, e, t, n, Math.pow(2, 8 * n) - 1, 0);
    var u = 1,
        o = 0;
    ...
    if ("string" == typeof e) {
      ...
      if ("string" == typeof r && !kn.isEncoding(r)) throw new TypeError("Unknown encoding: " + r);
  ...
  function cr(e) {
    return function (e) {
      ...
      o = "=" === e[i - 2] ? 2 : "=" === e[i - 1] ? 1 : 0, a = new En(3 * i / 4 - o), r = o > 0 ? i - 4 : i;
      var s = 0;
  ...
  var hr = /*#__PURE__*/function () {
    ...
    _createClass(hr, [{
      ...
      value: function _readChunk(e) {
        ...
        do {
          var _e14 = new kn(this.options.readChunk);

          t = fr.readSync(this.fd, _e14, 0, this.options.readChunk, this.fdPosition), n += t, this.fdPosition = this.fdPosition + t, r.push(_e14);
        } while (t && -1 === this._searchInBuffer(r[r.length - 1], this.options.newLineCharacter));

        var u = kn.concat(r);
        return t < this.options.readChunk && (this.eofReached = !0, u = u.slice(0, n)), n && (this.linesCache = this._extractLines(u), e && (this.linesCache[0] = kn.concat([e, this.linesCache[0]]))), n;
      }
    }, {
      key: "next",
      value: function next() {
  ...
  var gr = /*#__PURE__*/function (_Error) {
    _inherits(gr, _Error);

    var _super = _createSuper(gr);
  ...
  var Dr = /*#__PURE__*/function (_Error2) {
    _inherits(Dr, _Error2);

    var _super2 = _createSuper(Dr);
  ...
  var yr = /*#__PURE__*/function (_Error3) {
    _inherits(yr, _Error3);

    var _super3 = _createSuper(yr);
  ...
  var Er = {
    ConfigError: gr,
    DebugError: Dr,
    UndefinedParserError: yr
  },
      _Cr = function Cr(e, t) {
    return (_Cr = Object.setPrototypeOf || {
      __proto__: []
  ...
  var xr = Object.freeze({
    ...
    __asyncValues: function __asyncValues(e) {
      ...
      return n ? n.call(e) : (e = Ar(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function () {
        return this;
      }, t);
  ...
  Object.keys(Or).forEach(function (e) {
    jr[e] = {}, Object.defineProperty(jr[e], "channels", {
      value: Or[e].channels
    }), Object.defineProperty(jr[e], "labels", {
      value: Or[e].labels
    });
  ...
  var Mr = jr,
    ...
    Object.defineProperty(e, "exports", {
      ...
      get: function get() {
        ...
        for (var _i5 = 0, _Object$keys3 = Object.keys(Mr); _i5 < _Object$keys3.length; _i5++) {
          var _e15 = _Object$keys3[_i5];
          if ("object" != _typeof(Mr[_e15])) continue;
          var _o4 = Mr[_e15];
  ...
  function $r(e) {
    return function (e) {
      ...
      if (!1 === Wr) return 0;
      if (qr("color=16m") || qr("color=full") || qr("color=truecolor")) return 3;
      if (qr("color=256")) return 2;
      if (e && !e.isTTY && !0 !== Wr) return 0;
      var t = Wr ? 1 : 0;

      if ("win32" === Re.platform) {
        var _e16 = Rr.release().split(".");
      ...
      if ("TERM_PROGRAM" in Vr) {
        var _e17 = parseInt((Vr.TERM_PROGRAM_VERSION || "").split(".")[0], 10);
  ...
  qr("no-color") || qr("no-colors") || qr("color=false") ? Wr = !1 : (qr("color") || qr("colors") || qr("color=true") || qr("color=always")) && (Wr = !0), "FORCE_COLOR" in Vr && (Wr = 0 === Vr.FORCE_COLOR.length || 0 !== parseInt(Vr.FORCE_COLOR, 10));
  var Ur = {
    supportsColor: $r,
    stdout: $r(Re.stdout),
    stderr: $r(Re.stderr)
  };
  var zr = /(?:\\(u[a-f\d]{4}|x[a-f\d]{2}|.))|(?:\{(~)?(\w+(?:\([^)]*\))?(?:\.\w+(?:\([^)]*\))?)*)(?:[ \t]|(?=\r?\n)))|(\})|((?:.|[\r\n\f])+?)/gi,
      Jr = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g,
      Gr = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/,
  ...
  function Kr(e, t) {
    ...
    try {
      for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
        ...
        if (isNaN(_t18)) {
          if (!(u = _t18.match(Gr))) throw new Error("Invalid Chalk template style argument: ".concat(_t18, " (in style '").concat(e, "')"));
          n.push(u[2].replace(Hr, function (e, t, n) {
            return t ? Yr(t) : n;
          }));
  ...
  var eu = function eu(e, t) {
    ...
    if (t.replace(zr, function (t, o, a, i, s, l) {
      if (o) u.push(Yr(o));else if (i) {
        var _t20 = u.join("");

        u = [], r.push(0 === n.length ? _t20 : Zr(e, n)(_t20)), n.push({
          inverse: a,
          styles: Qr(i)
        });
      } else if (s) {
        if (0 === n.length) throw new Error("Found extraneous } in Chalk template literal");
        r.push(Zr(e, n)(u.join(""))), u = [], n.pop();
      } else u.push(l);
    ...
    for (var _i7 = 0, _Object$keys5 = Object.keys(Lr); _i7 < _Object$keys5.length; _i7++) {
      _loop2();
    }
        ...
        get: function get() {
          ...
          return function () {
            var n = Lr.color[r[t]][e].apply(null, arguments),
                u = {
              open: n,
              close: Lr.color.close,
              closeRe: Lr.color.closeRe
            };
    ...
    for (var _i8 = 0, _Object$keys6 = Object.keys(Lr.color.ansi); _i8 < _Object$keys6.length; _i8++) {
      _loop3();
    }
        ...
        get: function get() {
          ...
          return function () {
            var n = Lr.bgColor[r[t]][e].apply(null, arguments),
                u = {
              open: n,
              close: Lr.bgColor.close,
              closeRe: Lr.bgColor.closeRe
            };
            return l.call(this, this._styles ? this._styles.concat(u) : [u], this._empty, e);
          };
        }
    ...
    for (var _i9 = 0, _Object$keys7 = Object.keys(Lr.bgColor.ansi); _i9 < _Object$keys7.length; _i9++) {
      var _ret = _loop4();
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      var r = ["".concat(tu.default.yellow("string" == typeof e ? n.key(e) : n.pair(e)), " is deprecated")];
      return t && r.push("we now treat it as ".concat(tu.default.blue("string" == typeof t ? n.key(t) : n.pair(t)))), r.join("; ") + ".";
    };
  }),
      ru = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), wr.__exportStar(nu, t);
  }),
      uu = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      var n = _ref8.descriptor,
          r = _ref8.logger,
          u = _ref8.schemas;
      var o = ["Ignored unknown option ".concat(tu.default.yellow(n.pair({
        key: e,
        value: t
      })), ".")],
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), wr.__exportStar(su, t);
  }),
      cu = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), wr.__exportStar(ru, t), wr.__exportStar(ou, t), wr.__exportStar(lu, t);
  }),
      pu = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    ...
    var n = /*#__PURE__*/function (_pu$Schema) {
    ...
    var n = /*#__PURE__*/function (_pu$Schema2) {
    ...
    var n = /*#__PURE__*/function (_pu$Schema3) {
    ...
    var n = /*#__PURE__*/function (_pu$Schema4) {
    ...
    var n = /*#__PURE__*/function (_pu$Schema5) {
      ...
      function n(e) {
        ...
        _this3 = _super8.call(this, e), _this3._choices = gu.mapFromArray(e.choices.map(function (e) {
    ...
    var n = /*#__PURE__*/function (_pu$Schema6) {
    ...
    var n = /*#__PURE__*/function (_yu$NumberSchema) {
      ...
      _createClass(n, [{
        ...
        key: "validate",
        value: function validate(e, t) {
          return !0 === t.normalizeValidateResult(_get(_getPrototypeOf(n.prototype), "validate", this).call(this, e, t), e) && gu.isInt(e);
        }
      }]);
    ...
    var n = /*#__PURE__*/function (_pu$Schema7) {
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), wr.__exportStar(du, t), wr.__exportStar(fu, t), wr.__exportStar(hu, t), wr.__exportStar(mu, t), wr.__exportStar(Du, t), wr.__exportStar(Eu, t), wr.__exportStar(yu, t), wr.__exportStar(Cu, t);
  }),
      Au = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.defaultDescriptor = Sr.apiDescriptor, t.defaultUnknownHandler = su.levenUnknownHandler, t.defaultInvalidHandler = ou.commonInvalidHandler, t.defaultDeprecatedHandler = nu.commonDeprecatedHandler;
  }),
      vu = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    ...
    var n = /*#__PURE__*/function () {
      function n(e, t) {
        ...
        var _ref12 = t || {},
            ...
            r = _ref12$descriptor === void 0 ? Au.defaultDescriptor : _ref12$descriptor,
            _ref12$unknown = _ref12.unknown,
            u = _ref12$unknown === void 0 ? Au.defaultUnknownHandler : _ref12$unknown,
            _ref12$invalid = _ref12.invalid,
            o = _ref12$invalid === void 0 ? Au.defaultInvalidHandler : _ref12$invalid,
            _ref12$deprecated = _ref12.deprecated,
            a = _ref12$deprecated === void 0 ? Au.defaultDeprecatedHandler : _ref12$deprecated;
        ...
        this._utils = {
          ...
          schemas: gu.recordFromArray(e, "name"),
          normalizeDefaultResult: gu.normalizeDefaultResult,
          normalizeDeprecatedResult: gu.normalizeDeprecatedResult,
          normalizeForwardResult: gu.normalizeForwardResult,
          normalizeRedirectResult: gu.normalizeRedirectResult,
          normalizeValidateResult: gu.normalizeValidateResult
      ...
      _createClass(n, [{
        ...
        value: function normalize(e) {
          ...
          for (var _i10 = 0, _Object$keys8 = Object.keys(this._utils.schemas); _i10 < _Object$keys8.length; _i10++) {
            ...
            if (!(_e32 in t)) {
              var _t22 = gu.normalizeDefaultResult(_r23.default(this._utils));
          ...
          try {
            var _loop5 = function _loop5() {
              ...
              var r = _this6._utils.schemas[u],
                  ...
                  a = gu.normalizeValidateResult(r.validate(o, _this6._utils), o);
              ...
              var i = function i(_ref13) {
                ...
                var e = _ref16.value,
                    t = _ref16.redirectTo;
                var n = gu.normalizeDeprecatedResult(r.deprecated(e, _this6._utils), o, !0);
              ...
              gu.normalizeForwardResult(r.forward(o, _this6._utils), o).forEach(i);
              var l = gu.normalizeRedirectResult(r.redirect(o, _this6._utils), o);
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), wr.__exportStar(Br, t), wr.__exportStar(cu, t), wr.__exportStar(bu, t), wr.__exportStar(vu, t), wr.__exportStar(pu, t);
  });
  ...
  for (var _i13 = 0, _Object$keys11 = Object.keys(ku); _i13 < _Object$keys11.length; _i13++) {
  ...
  for (var _i14 = 0, _Object$keys12 = Object.keys(Ou); _i14 < _Object$keys12.length; _i14++) {
    var _e40 = _Object$keys12[_i14];
    if (!("channels" in Ou[_e40])) throw new Error("missing channels property: " + _e40);
    if (!("labels" in Ou[_e40])) throw new Error("missing channel labels property: " + _e40);
    if (Ou[_e40].labels.length !== Ou[_e40].channels) throw new Error("channel and label counts mismatch: " + _e40);
    var _Ou$_e = Ou[_e40],
        _t25 = _Ou$_e.channels,
        _n22 = _Ou$_e.labels;
    delete Ou[_e40].channels, delete Ou[_e40].labels, Object.defineProperty(Ou[_e40], "channels", {
      value: _t25
    }), Object.defineProperty(Ou[_e40], "labels", {
      value: _n22
    });
  }
  ...
  Ou.rgb.hsl = function (e) {
    ...
    for (var _i15 = 0, _Object$keys13 = Object.keys(ku); _i15 < _Object$keys13.length; _i15++) {
      var _t26 = _Object$keys13[_i15];

      var _a7 = (o = ku[_t26], Math.pow((u = e)[0] - o[0], 2) + Math.pow(u[1] - o[1], 2) + Math.pow(u[2] - o[2], 2));
  ...
  Object.keys(Pu).forEach(function (e) {
    Mu[e] = {}, Object.defineProperty(Mu[e], "channels", {
      value: Pu[e].channels
    }), Object.defineProperty(Mu[e], "labels", {
      value: Pu[e].labels
    });
    ...
    var t = function (e) {
      ...
      for (var _e44 = r.length, _u10 = 0; _u10 < _e44; _u10++) {
        var _e45 = r[_u10];
        null !== t[_e45].parent && (n[_e45] = ju(_e45, t));
      }
  ...
  function zu(e, t) {
    if (0 === $u) return 0;
    if (Vu("color=16m") || Vu("color=full") || Vu("color=truecolor")) return 3;
    if (Vu("color=256")) return 2;
    if (e && !t && void 0 === $u) return 0;
    var n = $u || 0;
    if ("dumb" === Wu.TERM) return n;

    if ("win32" === Re.platform) {
      var _e47 = Rr.release().split(".");
    ...
    if ("CI" in Wu) return ["TRAVIS", "CIRCLECI", "APPVEYOR", "GITLAB_CI"].some(function (e) {
      return e in Wu;
    }) || "codeship" === Wu.CI_NAME ? 1 : n;
    if ("TEAMCITY_VERSION" in Wu) return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(Wu.TEAMCITY_VERSION) ? 1 : 0;
    if ("GITHUB_ACTIONS" in Wu) return 1;
    if ("truecolor" === Wu.COLORTERM) return 3;

    if ("TERM_PROGRAM" in Wu) {
      var _e48 = parseInt((Wu.TERM_PROGRAM_VERSION || "").split(".")[0], 10);
  ...
  Vu("no-color") || Vu("no-colors") || Vu("color=false") || Vu("color=never") ? $u = 0 : (Vu("color") || Vu("colors") || Vu("color=true") || Vu("color=always")) && ($u = 1), "FORCE_COLOR" in Wu && ($u = "true" === Wu.FORCE_COLOR ? 1 : "false" === Wu.FORCE_COLOR ? 0 : 0 === Wu.FORCE_COLOR.length ? 1 : Math.min(parseInt(Wu.FORCE_COLOR, 10), 3));
  var Ju = {
    supportsColor: function supportsColor(e) {
      return Uu(zu(e, e && e.isTTY));
    },
    stdout: Uu(zu(!0, qu.isatty(1))),
    stderr: Uu(zu(!0, qu.isatty(2)))
  };
  var Gu = {
  ...
  function Zu(e) {
    var t = "u" === e[0],
        n = "{" === e[1];
    return t && !n && 5 === e.length || "x" === e[0] && 3 === e.length ? String.fromCharCode(parseInt(e.slice(1), 16)) : t && n ? String.fromCodePoint(parseInt(e.slice(2, -1), 16)) : Qu.get(e) || e;
  }
    ...
    try {
      for (_iterator22.s(); !(_step22 = _iterator22.n()).done;) {
        ...
        if (Number.isNaN(_r32)) {
          if (!(u = _t32.match(Yu))) throw new Error("Invalid Chalk template style argument: ".concat(_t32, " (in style '").concat(e, "')"));
          n.push(u[2].replace(Ku, function (e, t, n) {
            return t ? Zu(t) : n;
          }));
        } else n.push(_r32);
      }
  ...
  function to(e) {
    ...
    for (; null !== (n = Xu.exec(e));) {
      var _e49 = n[1];

      if (n[2]) {
        var _r33 = eo(_e49, n[2]);
  ...
  var ro = function ro(e, t) {
    ...
    if (t.replace(Hu, function (t, o, a, i, s, l) {
      if (o) u.push(Zu(o));else if (i) {
        var _t35 = u.join("");

        u = [], r.push(0 === n.length ? _t35 : no(e, n)(_t35)), n.push({
          inverse: a,
          styles: to(i)
        });
      } else if (s) {
        if (0 === n.length) throw new Error("Found extraneous } in Chalk template literal");
        r.push(no(e, n)(u.join(""))), u = [], n.pop();
      } else u.push(l);
    }), r.push(u.join("")), n.length > 0) {
  ...
  var fo = function fo(e) {
    ...
    return function (e) {
      ...
      return bo.apply(void 0, [t.template].concat(e));
  ...
  var _loop6 = function _loop6() {
    ...
    co[e] = {
      get: function get() {
        var n = yo(this, Do(t.open, t.close, this._styler), this._isEmpty);
  ...
  for (var _i21 = 0, _Object$entries5 = Object.entries(Ru); _i21 < _Object$entries5.length; _i21++) {
    _loop6();
  }

  co.visible = {
    get: function get() {
      var e = yo(this, this._styler, !0);
      return Object.defineProperty(this, "visible", {
        value: e
      }), e;
    }
  };
  var mo = ["rgb", "hex", "keyword", "hsl", "hsv", "hwb", "ansi", "ansi256"];
    ...
    co[e] = {
      get: function get() {
        ...
        return function () {
          ...
          var r = Do((_Ru$color$lo$t = Ru.color[lo[t]])[e].apply(_Ru$color$lo$t, arguments), Ru.color.close, this._styler);
          return yo(this, r, this._isEmpty);
        };
      }
    };
  };

  for (var _i22 = 0, _mo = mo; _i22 < _mo.length; _i22++) {
    _loop7();
  }
    ...
    co["bg" + e[0].toUpperCase() + e.slice(1)] = {
      get: function get() {
        ...
        return function () {
          ...
          var r = Do((_Ru$bgColor$lo$t = Ru.bgColor[lo[t]])[e].apply(_Ru$bgColor$lo$t, arguments), Ru.bgColor.close, this._styler);
          return yo(this, r, this._isEmpty);
        };
      }
    };
  ...
  for (var _i23 = 0, _mo2 = mo; _i23 < _mo2.length; _i23++) {
    _loop8();
  }

  var go = Object.defineProperties(function () {}, Object.assign({}, co, {
    level: {
      enumerable: !0,
      get: function get() {
    ...
    var r = function r() {
      ...
      return so(e[0]) && so(e[0].raw) ? Eo(r, bo.apply(void 0, [r].concat(e))) : Eo(r, 1 === e.length ? "" + e[0] : e.join(" "));
    };
  ...
  var bo = function bo(e) {
    ...
    var n = t[0];
    if (!so(n) || !so(n.raw)) return t.join(" ");
    var r = t.slice(1),
        u = [n.raw[0]];
  ...
  var Ao = ho();
  Ao.supportsColor = uo, Ao.stderr = ho({
    level: oo ? oo.level : 0
  }), Ao.stderr.supportsColor = oo;
  var vo = Ao;
  ...
  var Fo = function Fo(e, t) {
    ...
    return e;
      ...
      xo = "object" == _typeof(We) && We && We.Object === Object && We,
  ...
  var Oo = function Oo(e) {
    ...
    var u = ko.call(e);
    return r && (t ? e[No] = n : delete e[No]), u;
  },
  ...
  var Lo = function Lo(e) {
    ...
    return Mo(e) && qo.call(e, "callee") && !Vo.call(e, "callee");
      ...
      $o = Array.isArray,
      Uo = wo ? wo.isConcatSpreadable : void 0;
  ...
  var Jo = function e(t, n, r, u, o) {
    ...
    for (r || (r = zo), o || (o = []); ++a < i;) {
      var s = t[a];
      n > 0 && r(s) ? n > 1 ? e(s, n - 1, r, u, o) : Fo(o, s) : u || (o[o.length] = s);
    }
  ...
  var Xo = /*#__PURE__*/function (_Fu$ChoiceSchema) {
    _inherits(Xo, _Fu$ChoiceSchema);

    var _super12 = _createSuper(Xo);
    ...
    _createClass(Xo, [{
      ...
      value: function preprocess(e, t) {
        if ("string" == typeof e && 0 !== e.length && !this._flags.includes(e)) {
          ...
          if (_n26) return t.logger.warn(["Unknown flag ".concat(vo.yellow(t.descriptor.value(e)), ","), "did you mean ".concat(vo.blue(t.descriptor.value(_n26)), "?")].join(" ")), _n26;
        }
  ...
  function Ko(t, n) {
    ...
    var a = o ? Array.isArray(o) ? function (e, t) {
      ...
      var u = e(r.schemas, ["_"]);
      return Fu.levenUnknownHandler(t, n, Object.assign({}, r, {
        schemas: u
      }));
    },
      ...
      try {
        for (_iterator25.s(); !(_step25 = _iterator25.n()).done;) {
          ...
          n.push(Qo(_r35, {
            isCLI: t,
            optionInfos: e
          })), _r35.alias && t && n.push(Fu.AliasSchema.create({
            name: _r35.alias,
    ...
    c && Yo && (l._hasDeprecationWarned = Yo);
    var p = l.normalize(t);
    return c && (Yo = l._hasDeprecationWarned), p;
  }

  function Qo(e, _ref23) {
    var t = _ref23.isCLI,
    ...
    return e.array ? Fu.ArraySchema.create(Object.assign({}, t ? {
  ...
  function ea(e, t) {
    ...
    if (!n) {
      ...
      if (_t36 && _t36.length > 0) return ea(_t36[0]);
    }
  ...
  function ta(e) {
    ...
    return e.typeAnnotation ? Math.max(t, ta(e.typeAnnotation)) : t;
  }
  ...
  var na = {
    ...
    composeLoc: function composeLoc(e) {
      ...
      var n = ea(e);
      return [n, "number" == typeof t ? n + t : ta(t)];
    }
  },
      ra = $e(function (e, t) {
    Object.defineProperty(t, "__esModule", {
  ...
  Object.keys(ca).forEach(function (e) {
    ha[e] = {}, Object.defineProperty(ha[e], "channels", {
      value: ca[e].channels
    }), Object.defineProperty(ha[e], "labels", {
      value: ca[e].labels
    });
  ...
  var ma = ha,
    ...
    Object.defineProperty(e, "exports", {
      ...
      get: function get() {
        ...
        for (var _i26 = 0, _Object$keys16 = Object.keys(ma); _i26 < _Object$keys16.length; _i26++) {
          var _e56 = _Object$keys16[_i26];
          if ("object" != _typeof(ma[_e56])) continue;
          var _o8 = ma[_e56];
  ...
  function Ea(e) {
    return function (e) {
      ...
      if (qr("color=16m") || qr("color=full") || qr("color=truecolor")) return 3;
      if (qr("color=256")) return 2;
      if (e && !e.isTTY && !0 !== ya) return 0;
      var t = ya ? 1 : 0;

      if ("win32" === Re.platform) {
        var _e57 = Rr.release().split(".");
      ...
      if ("CI" in Da) return ["TRAVIS", "CIRCLECI", "APPVEYOR", "GITLAB_CI"].some(function (e) {
        return e in Da;
      }) || "codeship" === Da.CI_NAME ? 1 : t;
      if ("TEAMCITY_VERSION" in Da) return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(Da.TEAMCITY_VERSION) ? 1 : 0;
      if ("truecolor" === Da.COLORTERM) return 3;

      if ("TERM_PROGRAM" in Da) {
        var _e58 = parseInt((Da.TERM_PROGRAM_VERSION || "").split(".")[0], 10);
  ...
  qr("no-color") || qr("no-colors") || qr("color=false") ? ya = !1 : (qr("color") || qr("colors") || qr("color=true") || qr("color=always")) && (ya = !0), "FORCE_COLOR" in Da && (ya = 0 === Da.FORCE_COLOR.length || 0 !== parseInt(Da.FORCE_COLOR, 10));
  var Ca = {
    supportsColor: Ea,
    stdout: Ea(Re.stdout),
    stderr: Ea(Re.stderr)
  };
  var ba = /(?:\\(u[a-f\d]{4}|x[a-f\d]{2}|.))|(?:\{(~)?(\w+(?:\([^)]*\))?(?:\.\w+(?:\([^)]*\))?)*)(?:[ \t]|(?=\r?\n)))|(\})|((?:.|[\r\n\f])+?)/gi,
      Aa = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g,
      va = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/,
  ...
  function wa(e, t) {
    ...
    try {
      for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
        ...
        if (isNaN(_t42)) {
          if (!(u = _t42.match(va))) throw new Error("Invalid Chalk template style argument: ".concat(_t42, " (in style '").concat(e, "')"));
          n.push(u[2].replace(Fa, function (e, t, n) {
            return t ? Sa(t) : n;
          }));
  ...
  function Ba(e) {
    ...
    for (; null !== (n = Aa.exec(e));) {
      var _e59 = n[1];

      if (n[2]) {
        var _r39 = wa(_e59, n[2]);
  ...
  var ka = function ka(e, t) {
    ...
    if (t.replace(ba, function (t, o, a, i, s, l) {
      if (o) u.push(Sa(o));else if (i) {
        var _t44 = u.join("");

        u = [], r.push(0 === n.length ? _t44 : Ta(e, n)(_t44)), n.push({
          inverse: a,
          styles: Ba(i)
        });
      } else if (s) {
        if (0 === n.length) throw new Error("Found extraneous } in Chalk template literal");
        r.push(Ta(e, n)(u.join(""))), u = [], n.pop();
      } else u.push(l);
    }), r.push(u.join("")), n.length > 0) {
    ...
    for (var _i28 = 0, _Object$keys18 = Object.keys(ga); _i28 < _Object$keys18.length; _i28++) {
      _loop9();
    }
        ...
        get: function get() {
          ...
          return function () {
            var n = ga.color[r[t]][e].apply(null, arguments),
                u = {
              open: n,
              close: ga.color.close,
              closeRe: ga.color.closeRe
            };
            return l.call(this, this._styles ? this._styles.concat(u) : [u], this._empty, e);
          };
        }
    ...
    for (var _i29 = 0, _Object$keys19 = Object.keys(ga.color.ansi); _i29 < _Object$keys19.length; _i29++) {
      _loop10();
    }
        ...
        get: function get() {
          ...
          return function () {
            var n = ga.bgColor[r[t]][e].apply(null, arguments),
                u = {
              open: n,
              close: ga.bgColor.close,
              closeRe: ga.bgColor.closeRe
            };
            return l.call(this, this._styles ? this._styles.concat(u) : [u], this._empty, e);
          };
        }
    ...
    for (var _i30 = 0, _Object$keys20 = Object.keys(ga.bgColor.ansi); _i30 < _Object$keys20.length; _i30++) {
      var _ret2 = _loop11();
        ...
        return function (e, t) {
          return t.replace(r.default, function () {
            ...
            var n = function (e) {
              ...
              if ("name" === u.type) {
                if ((0, aa.isKeyword)(u.value) || (0, aa.isReservedWord)(u.value)) return "keyword";
  ...
  function Ra(e) {
    ...
    try {
      for (_iterator30.s(); !(_step30 = _iterator30.n()).done;) {
        ...
        if (_n33.parsers) {
          var _iterator31 = _createForOfIteratorHelper(Ma(_n33.parsers)),
              _step31;

          try {
            for (_iterator31.s(); !(_step31 = _iterator31.n()).done;) {
              var _e68 = _step31.value;
              Object.defineProperty(t, _e68, La(_n33.parsers, _e68));
            }
          } catch (err) {
            _iterator31.e(err);
          } finally {
  ...
  function qa(e, t) {
    if (t = t || Ra(e), "function" == typeof e.parser) return {
      parse: e.parser,
      astFormat: "estree",
      locStart: Ia,
      locEnd: ja
    ...
    if ("string" == typeof e.parser) {
      ...
      throw new _a("Couldn't resolve parser \"".concat(e.parser, '". Parsers must be explicitly added to the standalone bundle.'));
    }
  }
  ...
  var Wa = Er.UndefinedParserError,
      $a = yt.getSupportInfo,
      Ua = Va.resolveParser,
      za = {
    astFormat: "estree",
  ...
  function Ja(e, t) {
    ...
    if (!u && !n.includes(".")) {
      var _t47 = function (e) {
        ...
        try {
          var _e69 = new hr(t).next().toString("utf8"),
  ...
  var Ga = {
    normalize: function normalize(e, t) {
      ...
      return Object.keys(s).forEach(function (e) {
        null == n[e] && (n[e] = s[e]);
      }), "json" === n.parser && (n.trailingComma = "none"), Zo.normalizeApiOptions(n, r, Object.assign({
        passThrough: Object.keys(za)
      }, t));
    },
    hiddenDefaults: za,
    inferParser: Ja
  ...
  Xa.ok = function () {}, Xa.strictEqual = function () {};
  var _dn$builders = dn.builders,
  ...
  function di(e, t, n) {
    ...
    return a ? (n || Object.defineProperty(e, pi, {
      value: n = [],
      enumerable: !1
  ...
  function fi(e, t, n) {
    ...
    for (s = r; s > 0; --s) {
      var _r44 = e[s - 1];
      Xa.strictEqual(_r44.precedingNode, u), Xa.strictEqual(_r44.followingNode, o);
  ...
  var Di = {
    attach: function attach(e, t, n, r) {
      ...
      e.forEach(function (i, s) {
        if ("json" === r.parser || "json5" === r.parser || "__js_expression" === r.parser || "__vue_expression" === r.parser) {
          if (o(i) - o(t) <= 0) return void si(t, i);
          if (a(i) - a(t) >= 0) return void ci(t, i);
        }
        ...
        !function e(t, n, r) {
          ...
          if (n.enclosingNode && "TemplateLiteral" === n.enclosingNode.type) {
            ...
            i && mi(_e72, i, r) !== _t51 && (i = null), s && mi(_e72, s, r) !== _t51 && (s = null);
          }
        ...
        if (ui(n, o(i), {
          backwards: !0
        })) d(i, n, r, t, m) || (p ? si(p, i) : l ? ci(l, i) : li(c || t, i));else if (ui(n, a(i))) f(i, n, r, t, m) || (l ? ci(l, i) : p ? si(p, i) : li(c || t, i));else if (h(i, n, r, t, m)) ;else if (l && p) {
          var _e73 = u.length;

          if (_e73 > 0) {
            u[_e73 - 1].followingNode !== i.followingNode && fi(u, n, r);
          }
    ...
    printComments: function printComments(e, t, n, r) {
      var u = e.getValue(),
          o = t(e),
          a = u && u.comments;
      if (!a || 0 === a.length) return gi(e, n, o);
      var i = [],
          s = [r ? ";" : "", o];
        ...
        if (r) {
          var _r45 = function (e, t) {
            ...
            if (t.printer.isBlockComment && t.printer.isBlockComment(n)) {
              var _e74 = ui(t.originalText, t.locEnd(n)) ? ui(t.originalText, t.locStart(n), {
                backwards: !0
              }) ? Qa : Ka : " ";
          ...
          var _u13 = n.originalText,
              _o9 = oi(_u13, ai(_u13, n.locEnd(t)));

          !1 !== _o9 && ui(_u13, _o9) && i.push(Qa);
          ...
          if (ui(o, a(n), {
            ...
            return ti(Ya([Qa, _e75 ? Qa : "", r]));
          }

          var s = Ya([" ", r]);
          return i || (s = Ya([ti(s), Za])), s;
        }(e, n));
    ...
    printDanglingComments: function printDanglingComments(e, t, n, r) {
      ...
      return o && o.comments ? (e.each(function (e) {
        var n = e.getValue();
        !n || n.leading || n.trailing || r && !r(n) || u.push(hi(e, t));
      }, "comments"), 0 === u.length ? "" : n ? ni(Qa, u) : ei(Ya([Qa, ni(Qa, u)]))) : "";
    },
    getSortedChildNodes: di,
    ...
    printSubtree: function printSubtree(e, t, n, r) {
      if (n.printer.embed && "auto" === n.embeddedLanguageFormatting) return n.printer.embed(e, t, function (e, t, u) {
        return function (e, t, n, r) {
          ...
          e = a.text;
          var s = i.comments;
          delete i.comments, Di.attach(s, i, e, o), o[Symbol.for("comments")] = s || [], o[Symbol.for("tokens")] = i.tokens || [];
          var l = r(i, o);
          if (Di.ensureAllCommentsPrinted(s), u) return "string" == typeof l ? l.replace(/(?:\r?\n)*$/, "") : bi(l, !0);
          return l;
        }(e, t, n, r, u);
      }, n);
    }
  ...
  function ki(e, t) {
    ...
    var o = function e(n, o) {
      ...
      var s;
      return s = r.willPrintOwnComments && r.willPrintOwnComments(n, t) ? Ni(n, t, e, o) : Di.printComments(n, function (n) {
        return Ni(n, t, e, o);
      }, t, o && o.needsSemi), i && u.set(a, s), s;
    }(new Ci(e));

    return n > 0 && (o = Bi(Si([wi, o]), n, t.tabWidth)), Ti.propagateBreaks(o), o;
  }

  function Ni(e, t, n, r) {
    Xa.ok(e instanceof Ci);
    var u = e.getValue(),
        o = t.printer;
    ...
    if (u) try {
      var _r47 = vi.printSubtree(e, n, t, ki);
  ...
  function Pi(e, t, n, r) {
    ...
    if (!(t < n.locStart(e) || t > n.locEnd(e))) {
      var _iterator33 = _createForOfIteratorHelper(Di.getSortedChildNodes(e, n)),
          _step33;
      ...
      try {
        for (_iterator33.s(); !(_step33 = _iterator33.n()).done;) {
          ...
          var _a11 = Pi(_o10, t, n, r, [e].concat(_toConsumableArray(u)));
  ...
  function ji(e, t) {
    ...
    switch (e.parser) {
      ...
      case "json":
        return _i.has(t.type);

      case "graphql":
        return Ii.has(t.kind);
  ...
  var Mi = {
    ...
    findNodeAtOffset: Pi
      ...
      Li = Ue(K);
  var Ri = dn.printer.printDocToString,
  ...
  function Hi(e, t, n) {
    var r = t.comments;
    return r && (delete t.comments, Di.attach(r, t, e, n)), n[Symbol.for("comments")] = r || [], n[Symbol.for("tokens")] = t.tokens || [], n.originalText = e, r;
  }
  ...
  function Xi(e, t, n) {
    ...
    if (e = r.text, t.cursorOffset >= 0) {
      var _e82 = Mi.findNodeAtOffset(u, t.cursorOffset, t);
    ...
    if (Di.ensureAllCommentsPrinted(o), n > 0) {
      var _e83 = i.formatted.trim();

      void 0 !== i.cursorNodeStart && (i.cursorNodeStart -= i.formatted.indexOf(_e83)), i.formatted = _e83 + $i(t.endOfLine);
    }
    ...
    if (t.cursorOffset >= 0) {
      ...
      _s4.splice(_u16, 0, Gi);

      var _l4 = _a12.split(""),
          _c3 = Li.diffArrays(_s4, _l4);
      ...
      try {
        for (_iterator36.s(); !(_step36 = _iterator36.n()).done;) {
          ...
          if (_e84.removed) {
            if (_e84.value.includes(Gi)) break;
          } else _p4 += _e84.count;
        }
      } catch (err) {
        _iterator36.e(err);
  ...
  function Yi(e, t) {
    ...
    "auto" === t.endOfLine && (t.endOfLine = Wi(u));
    ...
    if (r && (o && t.cursorOffset--, i && t.rangeStart--, s && t.rangeEnd--), u.includes("\r")) {
      ...
      o && (t.cursorOffset -= _e85(t.cursorOffset)), i && (t.rangeStart -= _e85(t.rangeStart)), s && (t.rangeEnd -= _e85(t.rangeEnd)), u = zi(u);
    }
    ...
    return t.rangeStart < 0 && (t.rangeStart = 0), t.rangeEnd > u.length && (t.rangeEnd = u.length), i || s ? l = function (e, t) {
      ...
      if ("lf" !== t.endOfLine) {
        var _e86 = $i(t.endOfLine);

        d >= 0 && "\r\n" === _e86 && (d += Ui(f.slice(0, d), "\n")), f = f.replace(/\n/g, _e86);
      }
  ...
  var Ki = {
    ...
    parse: function parse(e, t, n) {
      t = Ji(t), e = zi("\uFEFF" === e.charAt(0) ? e.slice(1) : e);
      var r = Va.parse(e, t);
      return n && (r.ast = Ha(r.ast, t)), r;
    },
    ...
    formatDoc: function formatDoc(e, t) {
      t = Ji(Object.assign({}, t, {
        parser: "babel"
      }));
      return Yi(qi(e), t).formatted;
    },
  ...
  var bs = {
    ...
    skipNewline: os,
    skipToLineEnd: as,
    skipEverythingButNewLine: is,
    skipInlineComment: ss,
    skipTrailingComment: ls,
    hasNewline: cs,
    hasNewlineInRange: ps,
    hasSpaces: ds,
    isNextLineEmpty: fs,
    isNextLineEmptyAfterIndex: hs,
    isPreviousLineEmpty: ms,
    getNextNonSpaceNonCommentCharacterIndex: gs,
    makeString: Ds,
    addLeadingComment: ys,
    addDanglingComment: Es,
    addTrailingComment: Cs
  },
      As = function As(t, n) {
    var r = t.languageId,
        u = e(t, ["languageId"]);
  ...
  function Is(e, t, n, r, u, o) {
    ...
    return ")" === Ss(e, u, o.locEnd) ? (ks(t, u), !0) : t === n.consequent && r === n.alternate ? ("BlockStatement" === t.type ? ks(t, u) : Ns(n, u), !0) : "BlockStatement" === r.type ? (Ps(r, u), !0) : "IfStatement" === r.type ? (_s(r.consequent, u), !0) : n.consequent === r && (Ts(r, u), !0);
  }

  function js(e, t, n, r, u, o) {
    if (!n || "WhileStatement" !== n.type || !r) return !1;
    return ")" === Ss(e, u, o.locEnd) ? (ks(t, u), !0) : "BlockStatement" === r.type && (Ps(r, u), !0);
  }
  ...
  function Ls(e, t, n, r) {
    if (e && ("ClassDeclaration" === e.type || "ClassExpression" === e.type || "DeclareClass" === e.type || "DeclareInterface" === e.type || "InterfaceDeclaration" === e.type || "TSInterfaceDeclaration" === e.type)) {
      if (e.decorators && e.decorators.length > 0 && (!n || "Decorator" !== n.type)) return ks(e.decorators[e.decorators.length - 1], r), !0;
      if (e.body && n === e.body) return Ps(e.body, r), !0;
      if (n) for (var _i37 = 0, _arr3 = ["implements", "extends", "mixins"]; _i37 < _arr3.length; _i37++) {
        var _u17 = _arr3[_i37];
        if (e[_u17] && n === e[_u17][0]) return !t || t !== e.id && t !== e.typeParameters && t !== e.superClass ? Ns(e, r, _u17) : ks(t, r), !0;
      }
    }
  ...
  function qs(e, t, n, r, u, o) {
    if (t && "FunctionTypeParam" === t.type && n && "FunctionTypeAnnotation" === n.type && r && "FunctionTypeParam" !== r.type) return ks(t, u), !0;
    if (t && ("Identifier" === t.type || "AssignmentPattern" === t.type) && n && zs(n) && ")" === Ss(e, u, o.locEnd)) return ks(t, u), !0;

    if (n && "FunctionDeclaration" === n.type && r && "BlockStatement" === r.type) {
      var _t57 = function () {
        if (0 !== (n.params || n.parameters).length) return xs(e, o.locEnd(vs(n.params || n.parameters)));
        var t = xs(e, o.locEnd(n.id));
        return !1 !== t && xs(e, t + 1);
      }();

      if (o.locStart(u) > _t57) return Ps(r, u), !0;
    }
  ...
  var Gs = {
    handleOwnLineComment: function handleOwnLineComment(e, t, n, r, u) {
      ...
      return qs(t, o, a, i, e, n) || function (e, t, n) {
        if (e && ("MemberExpression" === e.type || "OptionalMemberExpression" === e.type) && t && "Identifier" === t.type) return Ts(e, n), !0;
        return !1;
      }(a, i, e) || Is(t, o, a, i, e, n) || js(t, o, a, i, e, n) || Ms(a, o, i, e) || Ls(a, o, i, e) || Vs(a, e) || function (e, t, n) {
        if (e && ("ForInStatement" === e.type || "ForOfStatement" === e.type)) return Ts(e, n), !0;
        return !1;
      }(a, 0, e) || function (e, t, n, r) {
        if (t && ("UnionTypeAnnotation" === t.type || "TSUnionType" === t.type)) return Bs(r) && (n.prettierIgnore = !0, r.unignore = !0), !!e && (ks(e, r), !0);
        n && ("UnionTypeAnnotation" === n.type || "TSUnionType" === n.type) && Bs(r) && (n.types[0].prettierIgnore = !0, r.unignore = !0);
        return !1;
      }(o, a, i, e) || $s(a, r, e, u) || function (e, t, n, r, u) {
        if (n && "ImportSpecifier" === n.type && t && "ImportDeclaration" === t.type && Fs(e, u.locEnd(r))) return ks(n, r), !0;
        return !1;
      }(t, a, o, e, n) || function (e, t) {
        if (e && "AssignmentPattern" === e.type) return Ts(e, t), !0;
        return !1;
    ...
    handleEndOfLineComment: function handleEndOfLineComment(e, t, n, r, u) {
      var o = e.precedingNode,
          ...
          i = e.followingNode;
      return function (e, t) {
        if (e && Js(t)) return Ts(e, t), !0;
        return !1;
      }(i, e) || qs(t, o, a, i, e, n) || function (e, t, n, r, u, o) {
        var a = t && !ws(u, o.locEnd(t), o.locStart(r));
        if ((!t || !a) && e && ("ConditionalExpression" === e.type || "TSConditionalType" === e.type) && n) return Ts(n, r), !0;
        return !1;
      }(a, o, i, e, t, n) || Vs(a, e) || Is(t, o, a, i, e, n) || js(t, o, a, i, e, n) || Ms(a, o, i, e) || Ls(a, o, i, e) || Ws(a, e) || function (e, t, n) {
        if (t && ("CallExpression" === t.type || "OptionalCallExpression" === t.type) && e && t.callee === e && t.arguments.length > 0) return Ts(t.arguments[0], n), !0;
        return !1;
      }(o, a, e) || function (e, t) {
        if (e && ("Property" === e.type || "ObjectProperty" === e.type)) return Ts(e, t), !0;
        return !1;
      }(a, e) || $s(a, r, e, u) || function (e, t, n) {
        if (e && "TypeAlias" === e.type) return Ts(e, n), !0;
        return !1;
      }(a, 0, e) || function (e, t, n) {
        if (e && ("VariableDeclarator" === e.type || "AssignmentExpression" === e.type) && t && ("ObjectExpression" === t.type || "ArrayExpression" === t.type || "TemplateLiteral" === t.type || "TaggedTemplateExpression" === t.type || Us(n))) return Ts(t, n), !0;
        return !1;
      }(a, i, e);
    },
    handleRemainingComment: function handleRemainingComment(e, t, n, r, u) {
      ...
      return !!(Is(t, o, a, i, e, n) || js(t, o, a, i, e, n) || function (e, t, n) {
        if (e && ("ObjectProperty" === e.type || "Property" === e.type) && e.shorthand && e.key === t && "AssignmentPattern" === e.value.type) return ks(e.value.left, n), !0;
        return !1;
      }(a, o, e) || function (e, t, n, r) {
        if (")" !== Ss(e, n, r.locEnd)) return !1;
        if (t && (zs(t) && 0 === (t.params || t.parameters).length || ("CallExpression" === t.type || "OptionalCallExpression" === t.type || "NewExpression" === t.type) && 0 === t.arguments.length)) return Ns(t, n), !0;
        if (t && "MethodDefinition" === t.type && 0 === t.value.params.length) return Ns(t.value, n), !0;
        return !1;
      }(t, a, e, n) || Rs(t, a, o, e, n) || $s(a, r, e, u) || function (e, t, n, r) {
        if (!t || "ArrowFunctionExpression" !== t.type) return !1;
        var u = Os(e, n, r.locEnd);
        if (!1 !== u && "=>" === e.slice(u, u + 2)) return Ns(t, n), !0;
        return !1;
      }(t, a, e, n) || function (e, t, n, r, u) {
        if ("(" !== Ss(e, r, u.locEnd)) return !1;
        if (n && t && ("FunctionDeclaration" === t.type || "FunctionExpression" === t.type || "ClassMethod" === t.type || "MethodDefinition" === t.type || "ObjectMethod" === t.type)) return ks(n, r), !0;
        return !1;
      }(t, a, o, e, n) || function (e, t, n, r, u) {
        if (!t || "TSMappedType" !== t.type) return !1;
        if (r && "TSTypeParameter" === r.type && r.name) return Ts(r.name, u), !0;
        if (n && "TSTypeParameter" === n.type && n.constraint) return ks(n.constraint, u), !0;
        return !1;
      }(0, a, o, i, e) || function (e, t) {
        if (e && ("ContinueStatement" === e.type || "BreakStatement" === e.type) && !e.label) return ks(e, t), !0;
        return !1;
      }(a, e) || function (e, t, n, r, u) {
        if (!n && t && ("TSMethodSignature" === t.type || "TSDeclareFunction" === t.type || "TSAbstractMethodDefinition" === t.type) && ";" === Ss(e, r, u.locEnd)) return ks(t, r), !0;
        return !1;
      }(t, a, i, e, n));
    },
  ...
  function fl(e) {
    ...
    switch (n.type) {
      case "MemberExpression":
        return ml(n.object) || gl(n);

      case "CallExpression":
        return ml(n.callee) || "MemberExpression" === n.callee.type && ("MemberExpression" === n.callee.object.type && (ml(n.callee.object.object) || gl(n.callee.object)) || "CallExpression" === n.callee.object.type && ml(n.callee.object.callee));
    ...
    switch (u.type) {
      case "TemplateLiteral":
        {
          ...
          if (function (e) {
            var t = e.getValue(),
                n = e.getParentNode();
            return Dl(t, "GraphQL") || n && ("TaggedTemplateExpression" === n.type && ("MemberExpression" === n.tag.type && "graphql" === n.tag.object.name && "experimental" === n.tag.property.name || "Identifier" === n.tag.type && ("gql" === n.tag.name || "graphql" === n.tag.name)) || "CallExpression" === n.type && "Identifier" === n.callee.type && "graphql" === n.callee.name);
          }(e)) {
            ...
            for (var _e88 = 0; _e88 < _o14; _e88++) {
              ...
              var _m3 = null;
              _m3 = _h3 ? ll(_l5) : n(_s5, {
                parser: "graphql"
              }, {
                stripTrailingHardline: !0
              }), _m3 ? (_m3 = sl(_m3, !1), !_t59 && _d3 && _a14.push(""), _a14.push(_m3), !_i38 && _f3 && _a14.push("")) : _t59 || _i38 || !_d3 || _a14.push(""), _p5 && _a14.push(el(["${", _p5, "}"]));
            }
          ...
          if (_o12) return function (e, t, n, r, u) {
            ...
            var d = rl(n(s, {
              ...
              for (var _e89 = 0; _e89 < n.length; _e89++) {
                ...
                if (_e89 % 2 == 0) {
                  _r52 && (_r52 = il(_r52), u.embeddedInHtml && (_r52 = _r52.replace(/<\/(script)\b/gi, "<\\/$1")), t.push(_r52));
                  continue;
                }
              ...
              return el(t);
                ...
                f = /^\s/.test(s) ? " " : "",
                h = /\s$/.test(s) ? " " : "",
                m = "ignore" === u.htmlWhitespaceSensitivity ? Ks : f && h ? Ys : null;
            if (m) return tl(el(["`", Hs(el([m, tl(d)])), m, "`"]));
            return tl(el(["`", f, p > 1 ? Hs(tl(d)) : tl(d), h, "`"]));
          }(e, t, n, _o12, r);
          break;
        }
      ...
      case "TemplateElement":
        if (a && "TaggedTemplateExpression" === a.type && 1 === o.quasis.length && "Identifier" === a.tag.type && ("md" === a.tag.name || "markdown" === a.tag.name)) {
          ...
          return el(["" !== _t60 ? Hs(el([Qs, i(_e90.replace(new RegExp("^".concat(_t60), "gm"), ""))])) : el([Zs, nl(i(_e90))]), Qs]);
        }
  ...
  var Nl = {
    hasPragma: function hasPragma(e) {
      var t = Object.keys(kl(e).pragmas);
  ...
  var Jl = new Set(["ExportDefaultDeclaration", "ExportDefaultSpecifier", "DeclareExportDeclaration", "ExportNamedDeclaration", "ExportAllDeclaration"]);
  ...
  var rc = new Set(["BinaryExpression", "LogicalExpression", "NGPipeExpression"]);
  var uc = new Set(["AnyTypeAnnotation", "NullLiteralTypeAnnotation", "GenericTypeAnnotation", "ThisTypeAnnotation", "NumberTypeAnnotation", "VoidTypeAnnotation", "EmptyTypeAnnotation", "MixedTypeAnnotation", "BooleanTypeAnnotation", "BooleanLiteralTypeAnnotation", "StringTypeAnnotation"]);
  var oc = /^(skip|[fx]?(it|describe|test))$/;
  ...
  var Ec = {
    ...
    getParentExportDeclaration: function getParentExportDeclaration(e) {
      var t = e.getParentNode();
      return "declaration" === e.getName() && Gl(t) ? t : null;
    },
    ...
    isCallOrOptionalCallExpression: ac,
    ...
    isFunctionNotation: nc,
    isFunctionOrArrowExpression: Kl,
    isGetterOrSetter: ec,
    ...
    isLongCurriedCallExpression: function isLongCurriedCallExpression(e) {
      var t = e.getValue(),
          n = e.getParentNode();
      return ac(t) && ac(n) && n.callee === t && t.arguments.length > n.arguments.length && n.arguments.length > 0;
    },
    ...
    isTemplateOnItsOwnLine: function isTemplateOnItsOwnLine(e, t, n) {
      return ("TemplateLiteral" === e.type && dc(e) || "TaggedTemplateExpression" === e.type && dc(e.quasi)) && !Ml(t, n.locStart(e), {
        backwards: !0
      });
    },
    isTestCall: function e(t, n) {
      ...
      if (1 === t.arguments.length) {
        if (Ql(t) && n && e(n)) return Kl(t.arguments[0]);
        if ("Identifier" === (r = t).callee.type && /^(before|after)(Each|All)$/.test(r.callee.name) && 1 === r.arguments.length) return Ql(t.arguments[0]);
      ...
      }(t.arguments[1]) && t.arguments[1].params.length <= 1) || Ql(t.arguments[1]));
    ...
    isTheOnlyJSXElementInMarkdown: function isTheOnlyJSXElementInMarkdown(e, t) {
      ...
      var n = t.getNode();
      if (!n.expression || !Zl(n.expression)) return !1;
    ...
    returnArgumentHasLeadingComment: function returnArgumentHasLeadingComment(e, t) {
      if (cc(e.originalText, t, e)) return !0;
  ...
  function Bc(e, t) {
    ...
    if ("flow" !== t.parser && bc(e.getValue())) return !0;
    ...
    if ("ExportDefaultDeclaration" === n.type) return function e(t, n) {
      var r = t.getValue(),
          u = t.getParentNode();
      if ("FunctionExpression" === r.type || "ClassExpression" === r.type) return "ExportDefaultDeclaration" === u.type || !Bc(t, n);
      if (!Ac(r) || "ExportDefaultDeclaration" !== u.type && Bc(t, n)) return !1;
    ...
    if ("ArrowFunctionExpression" === n.type && n.body === u && "SequenceExpression" !== u.type && xc(u, !1) || "ExpressionStatement" === n.type && xc(u, !0)) return !0;
          ...
          case "BinaryExpression":
            {
              ...
              return _t68 > _a15 || (_t68 === _a15 && "right" === r ? (Xa.strictEqual(n.right, u), !0) : _t68 === _a15 && !Sc(_e96, _o16) || (_t68 < _a15 && "%" === _o16 ? "+" === _e96 || "-" === _e96 : !!Fc(_e96)));
            }
  ...
  function Tc(e) {
    ...
    switch (n.type) {
      case "NGPipeExpression":
        if ("number" == typeof r && n.arguments[r] === t && n.arguments.length - 1 === r) return e.callParent(Tc);
        break;
      ...
      case "BinaryExpression":
      case "LogicalExpression":
        if ("right" === r) return e.callParent(Tc);
        break;

      case "ConditionalExpression":
        if ("alternate" === r) return e.callParent(Tc);
        break;

      case "UnaryExpression":
        if (n.prefix) return e.callParent(Tc);
    }
  ...
  var np = function np(e, t, n) {
    ...
    if (0 === o.length) return zc(["(", Di.printDanglingComments(e, t, !0), ")"]);
    if (2 === o.length && "ArrowFunctionExpression" === o[0].type && 0 === o[0].params.length && "BlockStatement" === o[0].body.type && "ArrayExpression" === o[1].type && !o.some(function (e) {
      return e.comments;
    })) return zc(["(", e.call(n, "arguments", 0), ", ", e.call(n, "arguments", 1), ")"]);
    var a = !1,
        i = !1,
        s = !1;
    ...
    var l = o.length - 1,
      ...
      var u = e.getNode(),
          o = [n(e)];
      return r === l || (Lc(t.originalText, u, t.locEnd) ? (0 === r && (s = !0), a = !0, o.push(",", Gc, Gc)) : o.push(",", Jc)), i = function (e, t) {
      ...
      return c(e, 0);
        ...
        d = u || r.callee && "Import" === r.callee.type || !Uc(t, "all") ? "" : ",";

    function f() {
      return Xc(zc(["(", Yc(zc([Jc, zc(p)])), d, Jc, ")"]), {
        shouldBreak: !0
      });
    }

    if ("Decorator" !== e.getParentNode().type && Vc(o)) return f();
    ...
    var h = function (e) {
      ...
      var t = jc(e),
          n = Mc(e);
      return !Rc(t) && !qc(t) && tp(t) && (!n || n.type !== t.type);
    }(o);

    if (h || m) {
      var _t74 = (h ? p.slice(1).some(ep) : p.slice(0, -1).some(ep)) || a || i;
      ...
      return zc([_g3 ? Zc : "", Kc([_g3 || r.typeArguments || r.typeParameters ? Qc(f(), _D3) : _D3, zc(h ? ["(", Xc(_l6[0], {
        shouldBreak: !0
      }), zc(_l6.slice(1)), ")"] : ["(", zc(p.slice(0, -1)), Xc(jc(_l6), {
        shouldBreak: !0
      }), ")"]), f()], {
        shouldBreak: _t74
      })]);
    ...
    var g = zc(["(", Yc(zc([Hc, zc(p)])), Qc(d), Hc, ")"]);
    return $c(e) ? g : Xc(g, {
      shouldBreak: p.some(ep) || a
    });
  };
  ...
  var lp = {
    ...
    printMemberLookup: function printMemberLookup(e, t, n) {
      var r = e.call(n, "property"),
          u = e.getValue(),
          o = sp(e);
      return u.computed ? !u.property || rp(u.property) ? up([o, "[", r, "]"]) : ap(up([o, "[", ip(up([op, r])), op, "]"])) : up([o, ".", r]);
    },
  ...
  var _p = function _p(e, t, n) {
    ...
    function a(e) {
      var n = t.originalText,
          r = fp(n, e, t.locEnd);
      return ")" === n.charAt(r) ? !1 !== r && dp(n, r + 1) : pp(n, e, t.locEnd);
    }

    var i = e.getValue();
    o.unshift({
      node: i,
      printed: Ap([kp(e), Np(e, t, n), np(e, t, n)])
    }), i.callee && e.call(function (e) {
      return function e(r) {
        var u = r.getValue();
        gp(u) && (Ep(u.callee) || gp(u.callee)) ? (o.unshift({
          node: u,
          printed: Ap([Di.printComments(r, function () {
            return Ap([kp(r), Np(r, t, n), np(r, t, n)]);
          }, t), a(u) ? Fp : ""])
        }), r.call(function (t) {
          return e(t);
        }, "callee")) : Ep(u) ? (o.unshift({
          node: u,
          needsParens: kc(r, t),
          printed: Di.printComments(r, function () {
    ...
    for (; c < o.length && ("TSNonNullExpression" === o[c].node.type || gp(o[c].node) || ("MemberExpression" === o[c].node.type || "OptionalMemberExpression" === o[c].node.type) && o[c].node.computed && Cp(o[c].node.property)); ++c) {
      l.push(o[c]);
    }
    ...
    if (s.length <= D && !E) return yp(e) ? g : xp(g);
    var C = cp(s[f ? 1 : 0]).node,
        b = !gp(C) && a(C),
    ...
    return E || v.length > 2 && v.some(function (e) {
      ...
      var e = cp(cp(s)).node,
          t = cp(m);
      return gp(e) && Tp(t) && v.slice(0, -1).some(function (e) {
  ...
  var Up = Ec.isJSXNode,
      ...
      ed = _dn$builders8.breakParent;

  var td = function td(e, t, n, r) {
    var u = e.getValue(),
    ...
    if (r.shouldCheckJsx && (Up(u[r.testNodePropertyNames[0]]) || Up(o) || Up(a) || function (e) {
      return function (e) {
        var t = [];
        return function e(n) {
      ...
      var _s6 = Jp([Gp, "? ", o.type === r.conditionalNodeType ? Qp("", "(") : "", Kp(2, e.call(n, r.consequentNodePropertyName)), o.type === r.conditionalNodeType ? Qp("", ")") : "", Gp, ": ", a.type === r.conditionalNodeType ? e.call(n, r.alternateNodePropertyName) : Kp(2, e.call(n, r.alternateNodePropertyName))]);

      i.push(l.type !== r.conditionalNodeType || l[r.alternateNodePropertyName] === u || c ? _s6 : t.useTabs ? Zp(Yp(_s6)) : Kp(Math.max(0, t.tabWidth - 2), _s6));
    }
    ...
    }(Jp([].concat((C = Jp(r.beforeParts()), l.type === r.conditionalNodeType && l[r.alternateNodePropertyName] === u ? Kp(2, C) : C), f ? Jp(i) : Yp(Jp(i)), r.afterParts(y))));

    var C;
    return c ? Xp(Jp([Yp(Jp([Hp, E])), Hp])) : E;
  };
  ...
  function Jf(e, t, n) {
    var r = e.getValue();
    return bd(md([gd(Dd, e.map(n, "decorators")), Xd(r, t) ? yd : Dd]));
  }
  ...
  function Gf(e, t, n) {
    ...
    return e.map(function (e, a) {
      ...
      if (t.semi || o || Bf(t, e) || !function (e, t) {
        ...
        needsSemi: !0
      })) : c.push(";", s), !t.semi && o) if (Rd(e)) c.push(";");else if ("ClassProperty" === i.type) {
        var _e99 = u.body[a + 1];
        Ld(_e99) && c.push(";");
      }
  ...
  function Hf(e, t, n) {
    var r = e.getNode();
    if (r.computed) return md(["[", e.call(n, "key"), "]"]);
    var u = e.getParentNode(),
        o = r.key;
    if ("ClassPrivateProperty" === r.type && "Identifier" === o.type) return md(["#", e.call(n, "key")]);

    if ("consistent" === t.quoteProps && !Uf.has(u)) {
    ...
    if (("Identifier" === o.type || yf(o) && Af(sd(Pf(o))) && String(o.value) === sd(Pf(o)) && "typescript" !== t.parser && "babel-ts" !== t.parser) && ("json" === t.parser || "consistent" === t.quoteProps && Uf.get(u))) {
      var _n43 = id(JSON.stringify("Identifier" === o.type ? o.name : o.value.toString()), t);
  ...
  function Xf(e, t, n) {
    var r = e.getNode(),
        ...
        o = r.value || r,
        a = [];
    return u && "init" !== u && "method" !== u && "constructor" !== u ? (Xa.ok("get" === u || "set" === u), a.push(u, " ")) : (o.async && a.push("async "), o.generator && a.push("*")), a.push(Hf(e, t, n), r.optional || r.key.optional ? "?" : "", r === o ? Yf(e, t, n) : e.call(function (e) {
      return Yf(e, t, n);
    }, "value")), md(a);
  }

  function Yf(e, t, n) {
    var r = [Rf(e, t, n), bd(md([Qf(e, n, t), th(e, n, t)]))];
    return e.getNode().body ? r.push(" ", e.call(n, "body")) : r.push(t.semi ? ";" : ""), md(r);
  }
  ...
  function Kf(e, t, n) {
    ...
    return of(t.originalText, r.typeAnnotation, t) ? md([" /*: ", e.call(n, "typeAnnotation"), " */"]) : md([a ? "" : o ? "!: " : ": ", e.call(n, "typeAnnotation")]);
  }
  ...
  function Qf(e, t, n, r, u) {
    ...
    if (o[i]) {
      ...
      d = e.map(function (e, u) {
        var a = [],
            i = e.getValue();
        return a.push(t(e)), u === _r56 ? o.rest && a.push(",", Dd) : s || l || c ? a.push(", ") : fd(n.originalText, i, n.locEnd) ? a.push(",", yd, yd) : a.push(",", Dd), md(a);
      }, i);
    }
    ...
    var f = od(o[i]);
    if (c) return bd(md([Od(p), "(", md(d.map(Od)), ")"]));
    ...
    return md([p, "(", Ad(md([Ed, md(d)])), Sd(m && If(n, "all") ? "," : ""), Ed, ")"]);
  }
  ...
  function eh(e, t, n) {
    var r = e.getValue(),
        u = [];
    return r.async && u.push("async "), r.generator ? u.push("function* ") : u.push("function "), r.id && u.push(e.call(t, "id")), u.push(Rf(e, n, t), bd(md([Qf(e, t, n), th(e, t, n)])), r.body ? " " : "", e.call(t, "body")), md(u);
  }

  function th(e, t, n) {
    var r = e.getValue(),
        u = e.call(t, "returnType");
    if (r.returnType && of(n.originalText, r.returnType, n)) return md([" /*: ", u, " */"]);
    var o = [u];
    return r.returnType && r.returnType.typeAnnotation && o.unshift(": "), r.predicate && o.push(r.returnType ? " " : ": ", e.call(t, "predicate")), md(o);
  }
  ...
  function rh(e, t) {
    var n = Wd(e);
    return n ? Xa.strictEqual(n.type, "DeclareExportDeclaration") : t.unshift("declare "), md(t);
  }

  function uh(e, t, n) {
    var r = e.getValue();
    return r.modifiers && r.modifiers.length ? md([gd(" ", e.map(n, "modifiers")), " "]) : "";
  }
  ...
  function sh(e, t, n) {
    ...
    var o = r.id && Qd(r.id) || r.superClass && r.superClass.comments && 0 !== r.superClass.comments.length || r.extends && 0 !== r.extends.length || r.mixins && 0 !== r.mixins.length || r.implements && 0 !== r.implements.length,
        a = [],
        i = [];
    ...
    var s = ["superClass", "extends", "mixins", "implements"].filter(function (e) {
      return !!r[e];
        ...
        l = r.typeParameters && !Zd(r.typeParameters) && !s;

    function c(u) {
      if (r[u] && 0 !== r[u].length) {
        var _o18 = Di.printDanglingComments(e, t, !0, function (_ref31) {
          var e = _ref31.marker;
          return e === u;
        });

        i.push(l ? Sd(" ", Dd, {
          groupId: ah(r.typeParameters)
        }) : Dd, _o18, _o18 && yd, u, bd(Ad(md([Dd, gd(md([",", Dd]), e.map(n, u))]))));
      }
    }
    ...
    if (r.superClass) {
      ...
      o ? i.push(Dd, bd(_u20)) : i.push(" ", _u20);
    } else c("extends");

    if (c("mixins"), c("implements"), o) {
      var _e101 = md(i);

      l ? u.push(bd(md(a.concat(Sd(Ad(_e101), _e101))))) : u.push(bd(Ad(md(a.concat(_e101)))));
  ...
  function dh(e, t, n, r) {
    if (Gd(r.originalText, t, r)) return Ad(md([Dd, n]));
    return tf(t) && !ph(t) || "ConditionalExpression" === t.type && tf(t.test) && !ph(t.test) || "StringLiteralTypeAnnotation" === t.type || "ClassExpression" === t.type && t.decorators && t.decorators.length || ("Identifier" === e.type || Ff(e) || "MemberExpression" === e.type) && (Ff(t) || mf(t)) && "json" !== r.parser && "json5" !== r.parser || "SequenceExpression" === t.type ? bd(Ad(md([Dd, n]))) : md([" ", n]);
  }
  ...
  function Ch(e, t, n) {
    var r = e.getValue(),
        u = t.semi ? ";" : "",
        o = [];
    r.argument && (_f(t, r.argument) ? o.push(md([" (", Ad(md([yd, e.call(n, "argument")])), yd, ")"])) : tf(r.argument) || "SequenceExpression" === r.argument.type ? o.push(bd(md([Sd(" (", " "), Ad(md([Ed, e.call(n, "argument")])), Ed, Sd(")")]))) : o.push(" ", e.call(n, "argument")));
    var a = Array.isArray(r.comments) && r.comments[r.comments.length - 1],
        i = a && ("CommentLine" === a.type || "Line" === a.type);
    return i && o.push(u), Ud(r) && o.push(" ", Di.printDanglingComments(e, t, !0)), i || o.push(u), md(o);
  }
  ...
  var Ah = {
    ...
    print: function print(e, t, n, r) {
      ...
      var a = function (e, t, n, r) {
        ...
        switch (u.type) {
          ...
          case "ExpressionStatement":
            if (u.directive) return md([mh(u.expression, t, !0), o]);

            if ("__vue_event_binding" === t.parser) {
              var _t77 = e.getParentNode();

              if ("Program" === _t77.type && 1 === _t77.body.length && _t77.body[0] === u) return md([e.call(n, "expression"), Md(u.expression) ? ";" : ""]);
            }

            return md([e.call(n, "expression"), Bf(t, e) ? "" : o]);

          case "ParenthesizedExpression":
            return !u.expression.comments ? md(["(", e.call(n, "expression"), ")"]) : bd(md(["(", Ad(md([Ed, e.call(n, "expression")])), Ed, ")"]));

          case "AssignmentExpression":
            return fh(u.left, e.call(n, "left"), md([" ", u.operator]), u.right, e.call(n, "right"), t);
          ...
          case "NGPipeExpression":
            {
              var _r59 = e.getParentNode(),
                ...
                if (tf(i)) {
                  ...
                  a.push(_l8 ? "" : " ", _m5 ? bd(_d6, {
                    shouldBreak: _h5
                  }) : _d6), u && i.comments && (a = Pd(Di.printComments(t, function () {
                    return md(a);
                  }, r).parts));
                } else a.push(bd(t.call(n)));

                return a;
              }(e, n, t, !1, _a18);

              if (_a18) return md(_i39);
              if (("CallExpression" === _r59.type || "OptionalCallExpression" === _r59.type) && _r59.callee === u || "UnaryExpression" === _r59.type || ("MemberExpression" === _r59.type || "OptionalMemberExpression" === _r59.type) && !_r59.computed) return bd(md([Ad(md([Ed, md(_i39)])), Ed]));
              ...
              var _s7 = "ReturnStatement" === _r59.type || "ThrowStatement" === _r59.type || "JSXExpressionContainer" === _r59.type && "JSXAttribute" === _o19.type || "|" !== u.operator && "JsExpressionRoot" === _r59.type || "NGPipeExpression" !== u.type && ("NGRoot" === _r59.type && "__ng_binding" === t.parser || "NGMicrosyntaxExpression" === _r59.type && "NGMicrosyntax" === _o19.type && 1 === _o19.body.length) || u === _r59.body && "ArrowFunctionExpression" === _r59.type || u !== _r59.body && "ForStatement" === _r59.type || "ConditionalExpression" === _r59.type && "ReturnStatement" !== _o19.type && "ThrowStatement" !== _o19.type && "CallExpression" !== _o19.type && "OptionalCallExpression" !== _o19.type || "TemplateLiteral" === _r59.type,
                  ...
                  _c6 = tf(u.left) && jf(u.operator, u.left.operator);

              if (_s7 || ph(u) && !_c6 || !ph(u) && _l7) return bd(md(_i39));
              ...
              var _p6 = cf(u.right),
                ...
                return "string" != typeof e && "group" === e.type;
                  ...
                  _h4 = md(_i39.slice(_f4.length, _p6 ? -1 : void 0)),
                  _m4 = Symbol("logicalChain-" + ++zf),
                  _g4 = bd(md([].concat(_toConsumableArray(_f4), [Ad(_h4)])), {
                id: _m4
              });
              ...
              return bd(md([_g4, Sd(Ad(_D4), _D4, {
                groupId: _m4
              })]));
            }

          case "AssignmentPattern":
            return md([e.call(n, "left"), " = ", e.call(n, "right")]);
          ...
          case "TSTypeAssertion":
            {
              var _t78 = !("ArrayExpression" === u.expression.type || "ObjectExpression" === u.expression.type),
                  ...
                  _o20 = md([Sd("("), Ad(md([Ed, e.call(n, "expression")])), Ed, Sd(")")]);

              return _t78 ? Fd([md([_r60, e.call(n, "expression")]), md([_r60, bd(_o20, {
                shouldBreak: !0
              })]), md([_r60, e.call(n, "expression")])]) : bd(md([_r60, e.call(n, "expression")]));
            }
          ...
          case "MemberExpression":
            {
              ...
              return md([e.call(n, "object"), _i40 ? qf(e, t, n) : bd(Ad(md([Ed, qf(e, t, n)])))]);
            }

          case "MetaProperty":
            return md([e.call(n, "meta"), ".", e.call(n, "property")]);

          case "BindExpression":
            return u.object && i.push(e.call(n, "object")), i.push(bd(Ad(md([Ed, Vf(e, t, n)])))), md(i);

          case "Identifier":
            return md([u.name, Lf(e), Kf(e, t, n)]);
          ...
          case "ObjectTypeSpreadProperty":
            return md(["...", e.call(n, "argument"), Kf(e, t, n)]);

          case "FunctionDeclaration":
          case "FunctionExpression":
            return i.push(eh(e, n, t)), u.body || i.push(o), md(i);

          case "ArrowFunctionExpression":
            {
              u.async && i.push("async "), Zf(e, t) ? i.push(e.call(n, "params", 0)) : i.push(bd(md([Qf(e, n, t, r && (r.expandLastArg || r.expandFirstArg), !0), th(e, n, t)])));

              var _o22 = Di.printDanglingComments(e, t, !0, function (e) {
                var n = hd(t.originalText, e, t.locEnd);
              ...
              if (!Gd(t.originalText, u.body, t) && ("ArrayExpression" === u.body.type || "ObjectExpression" === u.body.type || "BlockStatement" === u.body.type || cf(u.body) || Sf(u.body, t.originalText, t) || "ArrowFunctionExpression" === u.body.type || "DoExpression" === u.body.type)) return bd(md([md(i), " ", _a20]));
              if ("SequenceExpression" === u.body.type) return bd(md([md(i), bd(md([" (", Ad(md([Ed, _a20])), Ed, ")"]))]));
              ...
              var _s9 = (r && r.expandLastArg || "JSXExpressionContainer" === e.getParentNode().type) && !(u.comments && u.comments.length),
                  ...
                  _c8 = "ConditionalExpression" === u.body.type && !Mf(u.body, !1);

              return bd(md([md(i), bd(md([Ad(md([Dd, _c8 ? Sd("", "(") : "", _a20, _c8 ? Sd("", ")") : ""])), _s9 ? md([Sd(_l9 ? "," : ""), Ed]) : ""]))]));
            }

          case "YieldExpression":
            return i.push("yield"), u.delegate && i.push("*"), u.argument && i.push(" ", e.call(n, "argument")), md(i);
          ...
          case "AwaitExpression":
            {
              ...
              return ("CallExpression" === _t79.type || "OptionalCallExpression" === _t79.type) && _t79.callee === u || ("MemberExpression" === _t79.type || "OptionalMemberExpression" === _t79.type) && _t79.object === u ? bd(md([Ad(md([Ed, md(i)])), Ed])) : md(i);
            }

          case "ImportSpecifier":
            return u.importKind && i.push(e.call(n, "importKind"), " "), i.push(e.call(n, "imported")), u.local && u.local.name !== u.imported.name && i.push(" as ", e.call(n, "local")), md(i);

          case "ExportSpecifier":
            return i.push(e.call(n, "local")), u.exported && u.exported.name !== u.local.name && i.push(" as ", e.call(n, "exported")), md(i);

          case "ImportNamespaceSpecifier":
            return i.push("* as "), i.push(e.call(n, "local")), md(i);

          case "ImportDefaultSpecifier":
            return e.call(n, "local");

          case "TSExportAssignment":
            return md(["export = ", e.call(n, "expression"), o]);
          ...
          case "DeclareExportDeclaration":
            return md(["declare ", nh(e, t, n)]);

          case "ExportAllDeclaration":
            return i.push("export"), "type" === u.exportKind && i.push(" type"), i.push(" *"), u.exported && i.push(" as ", e.call(n, "exported")), i.push(Wf(e, t, n), o), md(i);

          case "ExportNamespaceSpecifier":
            return md(["* as ", e.call(n, "exported")]);

          case "ExportDefaultSpecifier":
            return e.call(n, "exported");

          case "ImportDeclaration":
            return i.push("import"), u.importKind && "value" !== u.importKind && i.push(" ", u.importKind), u.specifiers && u.specifiers.length > 0 ? (i.push($f(e, t, n)), i.push(Wf(e, t, n))) : u.importKind && "type" === u.importKind || /{\s*}/.test(t.originalText.slice(t.locStart(u), t.locStart(u.source))) ? i.push(" {}", Wf(e, t, n)) : i.push(" ", e.call(n, "source")), Array.isArray(u.attributes) && 0 !== u.attributes.length && i.push(" with ", md(e.map(n, "attributes"))), i.push(o), md(i);

          case "ImportAttribute":
            return md([e.call(n, "key"), ": ", e.call(n, "value")]);
          ...
          case "CallExpression":
            {
              ...
              if (!_o23 && !_r63 && "Identifier" === u.callee.type && ("require" === u.callee.name || "define" === u.callee.name) || 1 === _i41.length && Sf(_i41[0], t.originalText, t) || !_r63 && wf(u, e.getParentNode())) return md([_r63 ? "new " : "", e.call(n, "callee"), _a22, Rf(e, t, n), md(["(", _o23 ? e.call(n, "source") : gd(", ", e.map(n, "arguments")), ")"])]);

              var _s11 = u.callee && "Identifier" === u.callee.type && zd(u.callee.trailingComments);

              if (_s11 && (u.callee.trailingComments[0].printed = !0), !_o23 && !_r63 && gf(u.callee) && !e.call(function (e) {
                return kc(e, t);
              }, "callee")) return _p(e, t, n);

              var _l11 = md([_r63 ? "new " : "", _o23 ? "import" : e.call(n, "callee"), _a22, _s11 ? "/*:: ".concat(u.callee.trailingComments[0].value.slice(2).trim(), " */") : "", Rf(e, t, n), np(e, t, n)]);

              return _o23 || nf(u.callee) ? bd(_l11) : _l11;
            }

          case "ObjectTypeInternalSlot":
            return md([u.static ? "static " : "", "[[", e.call(n, "id"), "]]", Lf(e), u.method ? "" : ": ", e.call(n, "value")]);
          ...
          case "RecordExpression":
            {
              ...
              var _D5 = _m6.sort(function (e, t) {
                ...
                var n = md(_g5.concat(bd(e.printed)));
                return _g5 = [_d7, Dd], "TSPropertySignature" !== e.node.type && "TSMethodSignature" !== e.node.type && "TSConstructSignatureDeclaration" !== e.node.type || !cd(e.node) || _g5.shift(), fd(t.originalText, e.node, t.locEnd) && _g5.push(yd), n;
              });
              ...
              if (u.inexact) {
                ...
                if (Ud(u)) {
                  var _r65 = !u.comments.every(Gs.isBlockComment),
                      _o24 = Di.printDanglingComments(e, t, !0);

                  _n45 = md([_o24, _r65 || rd(t.originalText, t.locEnd(u.comments[u.comments.length - 1])) ? yd : Dd, "..."]);
                } else _n45 = "...";

                _D5.push(md(_g5.concat(_n45)));
              }
              ...
              if (0 === _D5.length) {
                if (!Ud(u)) return md([_f6, _h6, Kf(e, t, n)]);
                _C2 = bd(md([_f6, Di.printDanglingComments(e, t), Ed, _h6, Lf(e), Kf(e, t, n)]));
              } else _C2 = md([_f6, Ad(md([t.bracketSpacing ? Dd : Ed, md(_D5)])), Sd(_E2 && ("," !== _d7 || If(t)) ? _d7 : ""), md([t.bracketSpacing ? Dd : Ed, _h6]), Lf(e), Kf(e, t, n)]);
          ...
          case "ObjectProperty":
          case "Property":
            return u.method || "get" === u.kind || "set" === u.kind ? Xf(e, t, n) : (u.shorthand ? i.push(e.call(n, "value")) : i.push(fh(u.key, Hf(e, t, n), ":", u.value, e.call(n, "value"), t)), md(i));
          ...
          case "TSDeclareMethod":
            return u.decorators && 0 !== u.decorators.length && i.push(Jf(e, t, n)), u.accessibility && i.push(u.accessibility + " "), u.static && i.push("static "), ("TSAbstractMethodDefinition" === u.type || u.abstract) && i.push("abstract "), i.push(Xf(e, t, n)), md(i);

          case "ObjectMethod":
            return Xf(e, t, n);

          case "Decorator":
            return md(["@", e.call(n, "expression"), e.call(n, "callee")]);
          ...
          case "TupleExpression":
            {
              ...
              if (0 === u.elements.length) Ud(u) ? i.push(bd(md([_r66, Di.printDanglingComments(e, t), Ed, _o25]))) : i.push(_r66, _o25);else {
                ...
                i.push(bd(md([_r66, Ad(md([Ed, Eh(e, t, "elements", n)])), _l13 ? "," : "", Sd(_s13 && !_l13 && If(t) ? "," : ""), Di.printDanglingComments(e, t, !0), Ed, _o25]), {
                  shouldBreak: _c11
                }));
              }
          ...
          case "SequenceExpression":
            {
              ...
              if ("ExpressionStatement" === _t80.type || "ForStatement" === _t80.type) {
                var _t81 = [];
                return e.each(function (e) {
                  0 === e.getName() ? _t81.push(n(e)) : _t81.push(",", Ad(md([Dd, n(e)])));
                }, "expressions"), bd(md(_t81));
              }
          ...
          case "StringLiteral":
          case "Literal":
            return u.regex ? gh(u.regex) : u.bigint ? u.raw.toLowerCase() : "number" == typeof u.value ? sd(u.raw) : "string" != typeof u.value ? "" + u.value : mh(u, t);
          ...
          case "UnaryExpression":
            return i.push(u.operator), /[a-z]$/.test(u.operator) && i.push(" "), u.argument.comments && u.argument.comments.length > 0 ? i.push(bd(md(["(", Ad(md([Ed, e.call(n, "argument")])), Ed, ")"]))) : i.push(e.call(n, "argument")), md(i);

          case "UpdateExpression":
            return i.push(e.call(n, "argument"), u.operator), u.prefix && i.reverse(), md(i);
          ...
          case "VariableDeclaration":
            {
              ...
              return 1 !== _t82.length || u.declarations[0].comments ? _t82.length > 0 && (_l14 = Ad(_t82[0])) : _l14 = _t82[0], i = [u.declare ? "declare " : "", u.kind, _l14 ? md([" ", _l14]) : "", Ad(md(_t82.slice(1).map(function (e) {
          ...
          case "TSTypeAliasDeclaration":
            {
              ...
              var _r68 = dh(u.id, u.typeAnnotation, u.typeAnnotation && e.call(n, "typeAnnotation"), t);

              return i.push("type ", e.call(n, "id"), e.call(n, "typeParameters"), " =", _r68, o), bd(md(i));
            }

          case "VariableDeclarator":
            return fh(u.id, e.call(n, "id"), " =", u.init, u.init && e.call(n, "init"), t);

          case "WithStatement":
            return bd(md(["with (", e.call(n, "object"), ")", hh(u.body, e.call(n, "body"))]));

          case "IfStatement":
            {
              var _r69 = hh(u.consequent, e.call(n, "consequent")),
                  _o26 = bd(md(["if (", bd(md([Ad(md([Ed, e.call(n, "test")])), Ed])), ")", _r69]));
              ...
              if (i.push(_o26), u.alternate) {
                ...
                i.push(_o27 ? " " : yd), Ud(u) && i.push(Di.printDanglingComments(e, t, !0), _r70 ? yd : " "), i.push("else", bd(hh(u.alternate, e.call(n, "alternate"), "IfStatement" === u.alternate.type)));
              }
          ...
          case "ForStatement":
            {
              var _r71 = hh(u.body, e.call(n, "body")),
                  ...
                  _a26 = _o28 ? md([_o28, Ed]) : "";

              return u.init || u.test || u.update ? md([_a26, bd(md(["for (", bd(md([Ad(md([Ed, e.call(n, "init"), ";", Dd, e.call(n, "test"), ";", Dd, e.call(n, "update")])), Ed])), ")", _r71]))]) : md([_a26, bd(md(["for (;;)", _r71]))]);
            }

          case "WhileStatement":
            return bd(md(["while (", bd(md([Ad(md([Ed, e.call(n, "test")])), Ed])), ")", hh(u.body, e.call(n, "body"))]));

          case "ForInStatement":
            return bd(md([u.each ? "for each (" : "for (", e.call(n, "left"), " in ", e.call(n, "right"), ")", hh(u.body, e.call(n, "body"))]));

          case "ForOfStatement":
            return bd(md(["for", u.await ? " await" : "", " (", e.call(n, "left"), " of ", e.call(n, "right"), ")", hh(u.body, e.call(n, "body"))]));

          case "DoWhileStatement":
            {
              var _t83 = hh(u.body, e.call(n, "body")),
                  _r72 = bd(md(["do", _t83]));

              return i = [_r72], "BlockStatement" === u.body.type ? i.push(" ") : i.push(yd), i.push("while ("), i.push(bd(md([Ad(md([Ed, e.call(n, "test")])), Ed])), ")", o), md(i);
            }

          case "DoExpression":
            return md(["do ", e.call(n, "body")]);

          case "BreakStatement":
            return i.push("break"), u.label && i.push(" ", e.call(n, "label")), i.push(o), md(i);

          case "ContinueStatement":
            return i.push("continue"), u.label && i.push(" ", e.call(n, "label")), i.push(o), md(i);

          case "LabeledStatement":
            return "EmptyStatement" === u.body.type ? md([e.call(n, "label"), ":;"]) : md([e.call(n, "label"), ": ", e.call(n, "body")]);

          case "TryStatement":
            return md(["try ", e.call(n, "block"), u.handler ? md([" ", e.call(n, "handler")]) : "", u.finalizer ? md([" finally ", e.call(n, "finalizer")]) : ""]);

          case "CatchClause":
            if (u.param) {
              var _r73 = u.param.comments && u.param.comments.some(function (e) {
                return !Gs.isBlockComment(e) || e.leading && rd(t.originalText, t.locEnd(e)) || e.trailing && rd(t.originalText, t.locStart(e), {
                  backwards: !0
                });
              }),
                  _o29 = e.call(n, "param");

              return md(["catch ", md(_r73 ? ["(", Ad(md([Ed, _o29])), Ed, ") "] : ["(", _o29, ") "]), e.call(n, "body")]);
            }

            return md(["catch ", e.call(n, "body")]);

          case "ThrowStatement":
            return md(["throw", Ch(e, t, n)]);

          case "SwitchStatement":
            return md([bd(md(["switch (", Ad(md([Ed, e.call(n, "discriminant")])), Ed, ")"])), " {", u.cases.length > 0 ? Ad(md([yd, gd(yd, e.map(function (e) {
              var r = e.getValue();
              return md([e.call(n), u.cases.indexOf(r) !== u.cases.length - 1 && fd(t.originalText, r, t.locEnd) ? yd : ""]);
            }, "cases"))])) : "", yd, "}"]);
          ...
          case "SwitchCase":
            {
              ...
              if (_r74.length > 0) {
                ...
                i.push(1 === _r74.length && "BlockStatement" === _r74[0].type ? md([" ", _u21]) : Ad(md([yd, _u21])));
              }
          ...
          case "JSXAttribute":
            if (i.push(e.call(n, "name")), u.value) {
              ...
              if (Ff(u.value)) {
                var _e102 = Pf(u.value).replace(/&apos;/g, "'").replace(/&quot;/g, '"');

                var _n46 = dd(_e102, t.jsxSingleQuote ? "'" : '"'),
                    _o30 = "'" === _n46 ? "&apos;" : "&quot;";

                _e102 = _e102.slice(1, -1).replace(new RegExp(_n46, "g"), _o30), _r75 = md([_n46, _e102, _n46]);
          ...
          case "JSXNamespacedName":
            return gd(":", [e.call(n, "namespace"), e.call(n, "name")]);

          case "JSXMemberExpression":
            return gd(".", [e.call(n, "object"), e.call(n, "property")]);

          case "TSQualifiedName":
            return gd(".", [e.call(n, "left"), e.call(n, "right")]);
          ...
          case "JSXSpreadChild":
            return md(["{", e.call(function (e) {
              var r = md(["...", n(e)]),
                  u = e.getValue();
              return u.comments && u.comments.length && bh(e) ? md([Ad(md([Ed, Di.printComments(e, function () {
                return r;
              }, t)])), Ed]) : r;
          ...
          case "JSXExpressionContainer":
            {
              var _t84 = e.getParentNode(0),
                  ...
                  _o31 = "JSXEmptyExpression" === u.expression.type || !_r76 && ("ArrayExpression" === u.expression.type || "ObjectExpression" === u.expression.type || "ArrowFunctionExpression" === u.expression.type || "CallExpression" === u.expression.type || "OptionalCallExpression" === u.expression.type || "FunctionExpression" === u.expression.type || "TemplateLiteral" === u.expression.type || "TaggedTemplateExpression" === u.expression.type || "DoExpression" === u.expression.type || cf(_t84) && ("ConditionalExpression" === u.expression.type || tf(u.expression)));

              return bd(_o31 ? md(["{", e.call(n, "expression"), wd, "}"]) : md(["{", Ad(md([Ed, e.call(n, "expression")])), Ed, wd, "}"]));
            }
          ...
          case "JSXElement":
            {
              var _r77 = Di.printComments(e, function () {
                return function (e, t, n) {
                  var r = e.getValue();
                  if ("JSXElement" === r.type && rf(r)) return md([e.call(n, "openingElement"), e.call(n, "closingElement")]);
                  ...
                  if (1 === r.children.length && "JSXExpressionContainer" === r.children[0].type && ("TemplateLiteral" === r.children[0].expression.type || "TaggedTemplateExpression" === r.children[0].expression.type)) return md([u, md(e.map(n, "children")), o]);
                  ...
                  var c = "mdx" === e.getParentNode().rootMarker,
                    ...
                    return e.map(function (e, t) {
                      ...
                      if (ff(i)) {
                        ...
                        if (hf(i)) {
                          var _n47 = _e103.split(Nf);

                          if ("" === _n47[0]) {
                            if (a.push(""), _n47.shift(), /\n/.test(_n47[0])) {
                              var _e104 = o.children[t + 1];
                              a.push(ch(u, _n47[1], i, _e104));
                            } else a.push(r);
                          ...
                          if ("" === od(_n47) && (_n47.pop(), _s15 = _n47.pop()), 0 === _n47.length) return;
                          if (_n47.forEach(function (e, t) {
                            t % 2 == 1 ? a.push(Dd) : a.push(e);
                          }), void 0 !== _s15) {
                            if (/\n/.test(_s15)) {
                              var _e105 = o.children[t + 1];
                              a.push(ch(u, od(a), i, _e105));
                            } else a.push(r);
                          } else {
                            var _e106 = o.children[t + 1];
                            a.push(lh(u, od(a), i, _e106));
                          }
                        ...
                        if (_s16 && hf(_s16)) {
                          var _e107 = Pf(_s16).trim().split(Nf)[0];
                          a.push(lh(u, _e107, i, _s16));
                        } else a.push(yd);
                      }
                    }, "children"), a;
                  }(e, 0, n, d, f),
                  ...
                  for (var _e108 = h.length - 2; _e108 >= 0; _e108--) {
                    var _t85 = "" === h[_e108] && "" === h[_e108 + 1],
                        _n48 = h[_e108] === yd && "" === h[_e108 + 1] && h[_e108 + 2] === yd,
                        _r79 = (h[_e108] === Ed || h[_e108] === yd) && "" === h[_e108 + 1] && h[_e108 + 2] === d,
                        _u22 = h[_e108] === d && "" === h[_e108 + 1] && (h[_e108 + 2] === Ed || h[_e108 + 2] === yd),
                        _o32 = h[_e108] === d && "" === h[_e108 + 1] && h[_e108 + 2] === d,
                        _a27 = h[_e108] === Ed && "" === h[_e108 + 1] && h[_e108 + 2] === yd || h[_e108] === yd && "" === h[_e108 + 1] && h[_e108 + 2] === Ed;
                  ...
                  h.forEach(function (e, t) {
                    if (e === d) {
                      if (1 === t && "" === h[t - 1]) return 2 === h.length ? void g.push(p) : void g.push(md([p, yd]));
                      if (t === h.length - 1) return void g.push(p);
                      if ("" === h[t - 1] && h[t - 2] === yd) return void g.push(p);
                    }

                    g.push(e), Td(e) && (l = !0);
                  });
                  var D = m ? xd(g) : bd(md(g), {
                    shouldBreak: !0
                  });
                  if (c) return D;
                  var y = bd(md([u, Ad(md([yd, D])), yd, o]));
                  if (l) return y;
                  return Fd([bd(md([u, md(h), o])), y]);
                }(e, t, n);
              }, t);
              ...
              return function (e, t, n) {
                ...
                var u = e.match(void 0, function (e) {
                  ...
                  return "JSXExpressionContainer" === e.type;
                    ...
                    o = kc(e, n);
                return bd(md([o ? "" : Sd("("), Ad(md([Ed, t])), Ed, o ? "" : Sd(")")]), {
                  shouldBreak: u
                });
              }(e, _r77, t);
            }
          ...
          case "JSXOpeningElement":
            {
              ...
              if (_r80.selfClosing && !_r80.attributes.length && !_u23) return md(["<", e.call(n, "name"), e.call(n, "typeParameters"), " />"]);
              if (_r80.attributes && 1 === _r80.attributes.length && _r80.attributes[0].value && Ff(_r80.attributes[0].value) && !_r80.attributes[0].value.value.includes("\n") && !_u23 && (!_r80.attributes[0].comments || !_r80.attributes[0].comments.length)) return bd(md(["<", e.call(n, "name"), e.call(n, "typeParameters"), " ", md(e.map(n, "attributes")), _r80.selfClosing ? " />" : ">"]));

              var _o33 = _r80.attributes.length && Qd(od(_r80.attributes)),
              ...
              return bd(md(["<", e.call(n, "name"), e.call(n, "typeParameters"), md([Ad(md(e.map(function (e) {
                return md([Dd, n(e)]);
              }, "attributes"))), _r80.selfClosing ? Dd : _a28 ? ">" : Ed]), _r80.selfClosing ? "/>" : _a28 ? "" : ">"]), {
                shouldBreak: _i43
              });
            }

          case "JSXClosingElement":
            return md(["</", e.call(n, "name"), ">"]);

          case "JSXOpeningFragment":
          case "JSXClosingFragment":
            {
              var _n49 = u.comments && u.comments.length,
                  _r81 = _n49 && !u.comments.every(Gs.isBlockComment),
                  _o34 = "JSXOpeningFragment" === u.type;

              return md([_o34 ? "<" : "</", Ad(md([_r81 ? yd : _n49 && !_o34 ? " " : "", Di.printDanglingComments(e, t, !0)])), _r81 ? yd : "", ">"]);
            }
          ...
          case "JSXEmptyExpression":
            {
              var _n50 = u.comments && !u.comments.every(Gs.isBlockComment);

              return md([Di.printDanglingComments(e, t, !_n50), _n50 ? yd : ""]);
            }

          case "ClassBody":
            return u.comments || 0 !== u.body.length ? md(["{", u.body.length > 0 ? Ad(md([yd, e.call(function (e) {
              return Gf(e, t, n);
            }, "body")])) : Di.printDanglingComments(e, t), yd, "}"]) : "{}";

          case "ClassProperty":
          case "TSAbstractClassProperty":
          case "ClassPrivateProperty":
            {
              u.decorators && 0 !== u.decorators.length && i.push(Jf(e, t, n)), u.accessibility && i.push(u.accessibility + " "), u.declare && i.push("declare "), u.static && i.push("static "), ("TSAbstractClassProperty" === u.type || u.abstract) && i.push("abstract "), u.readonly && i.push("readonly ");

              var _r82 = qd(u);

              return _r82 && i.push(_r82), i.push(Hf(e, t, n), Lf(e), Kf(e, t, n)), u.value && i.push(" =", dh(u.key, u.value, e.call(n, "value"), t)), i.push(o), bd(md(i));
            }

          case "ClassDeclaration":
          case "ClassExpression":
            return u.declare && i.push("declare "), i.push(md(sh(e, t, n))), md(i);

          case "TSInterfaceHeritage":
          case "TSExpressionWithTypeArguments":
            return i.push(e.call(n, "expression")), u.typeParameters && i.push(e.call(n, "typeParameters")), md(i);
          ...
          case "TaggedTemplateExpression":
            return md([e.call(n, "tag"), e.call(n, "typeParameters"), e.call(n, "quasi")]);
          ...
          case "TSNamedTupleMember":
            return md([e.call(n, "label"), u.optional ? "?" : "", ": ", e.call(n, "elementType")]);

          case "TSTupleType":
          case "TupleTypeAnnotation":
            {
              var _r85 = "TSTupleType" === u.type ? "elementTypes" : "types",
                  _o36 = u[_r85].length > 0 && "TSRestType" === od(u[_r85]).type;

              return bd(md(["[", Ad(md([Ed, Eh(e, t, _r85, n)])), Sd(If(t, "all") && !_o36 ? "," : ""), Di.printDanglingComments(e, t, !0), Ed, "]"]));
            }
          ...
          case "ArrayTypeAnnotation":
            return md([e.call(n, "elementType"), "[]"]);
          ...
          case "DeclareClass":
            return rh(e, sh(e, t, n));

          case "TSDeclareFunction":
            return md([u.declare ? "declare " : "", eh(e, n, t), o]);

          case "DeclareFunction":
            return rh(e, ["function ", e.call(n, "id"), u.predicate ? " " : "", e.call(n, "predicate"), o]);

          case "DeclareModule":
            return rh(e, ["module ", e.call(n, "id"), " ", e.call(n, "body")]);

          case "DeclareModuleExports":
            return rh(e, ["module.exports", ": ", e.call(n, "typeAnnotation"), o]);

          case "DeclareVariable":
            return rh(e, ["var ", e.call(n, "id"), o]);

          case "DeclareExportAllDeclaration":
            return md(["declare export *", Wf(e, t, n)]);

          case "DeclareOpaqueType":
          case "OpaqueType":
            return i.push("opaque type ", e.call(n, "id"), e.call(n, "typeParameters")), u.supertype && i.push(": ", e.call(n, "supertype")), u.impltype && i.push(" = ", e.call(n, "impltype")), i.push(o), "DeclareOpaqueType" === u.type ? rh(e, i) : md(i);

          case "EnumDeclaration":
            return md(["enum ", e.call(n, "id"), " ", e.call(n, "body")]);
          ...
          case "EnumSymbolBody":
            ...
            return 0 === u.members.length ? i.push(bd(md(["{", Di.printDanglingComments(e, t), Ed, "}"]))) : i.push(bd(md(["{", Ad(md([yd, Eh(e, t, "members", n), If(t) ? "," : ""])), Di.printDanglingComments(e, t, !0), yd, "}"]))), md(i);

          case "EnumBooleanMember":
          case "EnumNumberMember":
          case "EnumStringMember":
            return md([e.call(n, "id"), " = ", "object" == _typeof(u.init) ? e.call(n, "init") : String(u.init)]);
          ...
          case "TSFunctionType":
            {
              ...
              var _s18 = "TSFunctionType" === u.type || !(("ObjectTypeProperty" === _r86.type || "ObjectTypeInternalSlot" === _r86.type) && !qd(_r86) && !_r86.optional && t.locStart(_r86) === t.locStart(u) || "ObjectTypeCallProperty" === _r86.type || _a30 && "DeclareFunction" === _a30.type),
              ...
              return Cf(_r86, t) && (_s18 = !0, _l16 = !0), _c13 && i.push("("), i.push(Qf(e, n, t, !1, !0)), (u.returnType || u.predicate || u.typeAnnotation) && i.push(_s18 ? " => " : ": ", e.call(n, "returnType"), e.call(n, "predicate"), e.call(n, "typeAnnotation")), _c13 && i.push(")"), bd(md(i));
            }

          case "TSRestType":
            return md(["...", e.call(n, "typeAnnotation")]);

          case "TSOptionalType":
            return md([e.call(n, "typeAnnotation"), "?"]);

          case "FunctionTypeParam":
            return md([e.call(n, "name"), Lf(e), u.name ? ": " : "", e.call(n, "typeAnnotation")]);

          case "GenericTypeAnnotation":
            return md([e.call(n, "id"), e.call(n, "typeParameters")]);
          ...
          case "TSInterfaceDeclaration":
            {
              ...
              ("DeclareInterface" === u.type || u.declare) && i.push("declare "), "TSInterfaceDeclaration" === u.type && i.push(u.abstract ? "abstract " : "", uh(e, t, n)), i.push("interface");
              var _r87 = [],
                  _o38 = [];
              "InterfaceTypeAnnotation" !== u.type && _r87.push(" ", e.call(n, "id"), e.call(n, "typeParameters"));

              var _a31 = u.typeParameters && !Zd(u.typeParameters);

              if (u.extends && 0 !== u.extends.length && _o38.push(_a31 ? Sd(" ", Dd, {
                groupId: ah(u.typeParameters)
              }) : Dd, "extends ", (1 === u.extends.length ? ef : Ad)(gd(md([",", Dd]), e.map(n, "extends")))), u.id && Qd(u.id) || u.extends && 0 !== u.extends.length) {
                var _e112 = md(_o38);

                _a31 ? i.push(bd(md(_r87.concat(Sd(Ad(_e112), _e112))))) : i.push(bd(Ad(md(_r87.concat(_e112)))));
              } else (_i44 = i).push.apply(_i44, _r87.concat(_o38));

              return i.push(" ", e.call(n, "body")), bd(md(i));
            }
          ...
          case "TSClassImplements":
            return md([e.call(n, "expression"), e.call(n, "typeParameters")]);
          ...
          case "IntersectionTypeAnnotation":
            {
              ...
              for (var _e113 = 0; _e113 < _t87.length; ++_e113) {
                0 === _e113 ? _r88.push(_t87[_e113]) : Ef(u.types[_e113 - 1]) && Ef(u.types[_e113]) ? _r88.push(md([" & ", _o39 ? Ad(_t87[_e113]) : _t87[_e113]])) : Ef(u.types[_e113 - 1]) || Ef(u.types[_e113]) ? (_e113 > 1 && (_o39 = !0), _r88.push(" & ", _e113 > 1 ? Ad(_t87[_e113]) : _t87[_e113])) : _r88.push(Ad(md([" &", Dd, _t87[_e113]])));
              }
          ...
          case "UnionTypeAnnotation":
            {
              var _r89 = e.getParentNode(),
                ...
                var r = e.call(n);
                return _a32 || (r = vd(2, r)), Di.printComments(e, function () {
                  return r;
                }, t);
              }, "types");

              if (_a32) return gd(" | ", _i45);

              var _s19 = _o40 && !Gd(t.originalText, u, t),
                  _l17 = md([Sd(md([_s19 ? Dd : "", "| "])), gd(md([Dd, "| "]), _i45)]);

              return kc(e, t) ? bd(md([Ad(_l17), Ed])) : "TupleTypeAnnotation" === _r89.type && _r89.types.length > 1 || "TSTupleType" === _r89.type && _r89.elementTypes.length > 1 ? bd(md([Ad(md([Sd(md(["(", Ed])), _l17])), Ed, Sd(")")])) : bd(_o40 ? Ad(_l17) : _l17);
            }
          ...
          case "ObjectTypeCallProperty":
            return u.static && i.push("static "), i.push(e.call(n, "value")), md(i);

          case "ObjectTypeIndexer":
            {
              var _t88 = qd(u);

              return md([_t88 || "", "[", e.call(n, "id"), u.id ? ": " : "", e.call(n, "key"), "]: ", e.call(n, "value")]);
            }
          ...
          case "ObjectTypeProperty":
            {
              ...
              var _o41 = "";
              return u.proto ? _o41 = "proto " : u.static && (_o41 = "static "), md([_o41, sf(u) ? u.kind + " " : "", _r90 || "", Hf(e, t, n), Lf(e), af(u, t) ? "" : ": ", e.call(n, "value")]);
            }

          case "QualifiedTypeIdentifier":
            return md([e.call(n, "qualification"), ".", e.call(n, "id")]);

          case "StringLiteralTypeAnnotation":
            return mh(u, t);

          case "NumberLiteralTypeAnnotation":
            return Xa.strictEqual(_typeof(u.value), "number"), null != u.extra ? sd(u.extra.raw) : sd(u.raw);
          ...
          case "TypeAlias":
            {
              ...
              var _r91 = dh(u.id, u.right, e.call(n, "right"), t);

              return i.push("type ", e.call(n, "id"), e.call(n, "typeParameters"), " =", _r91, o), bd(md(i));
            }

          case "TypeCastExpression":
            return md(["(", e.call(n, "expression"), Kf(e, t, n), ")"]);
          ...
          case "TypeParameterInstantiation":
            {
              ...
              return _u24 >= 0 && t.originalText.slice(_u24).match(/^\/\*\s*::/) ? md(["/*:: ", ih(e, t, n, "params"), " */"]) : ih(e, t, n, "params");
            }

          case "TSTypeParameterDeclaration":
          case "TSTypeParameterInstantiation":
            return ih(e, t, n, "params");
          ...
          case "TypeParameter":
            {
              ...
              if ("TSMappedType" === _r93.type) return i.push("[", e.call(n, "name")), u.constraint && i.push(" in ", e.call(n, "constraint")), i.push("]"), md(i);
              ...
              return _r93.params && 1 === _r93.params.length && Tf(t) && !u.constraint && "ArrowFunctionExpression" === _a33.type && i.push(","), md(i);
            }

          case "TypeofTypeAnnotation":
            return md(["typeof ", e.call(n, "argument")]);
          ...
          case "DeclaredPredicate":
            return md(["%checks(", e.call(n, "value"), ")"]);
          ...
          case "TSAsExpression":
            return md([e.call(n, "expression"), " as ", e.call(n, "typeAnnotation")]);

          case "TSArrayType":
            return md([e.call(n, "elementType"), "[]"]);

          case "TSPropertySignature":
            return u.export && i.push("export "), u.accessibility && i.push(u.accessibility + " "), u.static && i.push("static "), u.readonly && i.push("readonly "), i.push(Hf(e, t, n), Lf(e)), u.typeAnnotation && (i.push(": "), i.push(e.call(n, "typeAnnotation"))), u.initializer && i.push(" = ", e.call(n, "initializer")), md(i);

          case "TSParameterProperty":
            return u.accessibility && i.push(u.accessibility + " "), u.export && i.push("export "), u.static && i.push("static "), u.readonly && i.push("readonly "), i.push(e.call(n, "parameter")), md(i);

          case "TSTypeReference":
            return md([e.call(n, "typeName"), ih(e, t, n, "typeParameters")]);

          case "TSTypeQuery":
            return md(["typeof ", e.call(n, "exprName")]);

          case "TSIndexSignature":
            {
              var _r94 = e.getParentNode(),
                  _a34 = u.parameters.length > 1 ? Sd(If(t) ? "," : "") : "",
                  _i46 = bd(md([Ad(md([Ed, gd(md([", ", Ed]), e.map(n, "parameters"))])), _a34, Ed]));

              return md([u.export ? "export " : "", u.accessibility ? md([u.accessibility, " "]) : "", u.static ? "static " : "", u.readonly ? "readonly " : "", "[", u.parameters ? _i46 : "", u.typeAnnotation ? "]: " : "]", u.typeAnnotation ? e.call(n, "typeAnnotation") : "", "ClassBody" === _r94.type ? o : ""]);
            }

          case "TSTypePredicate":
            return md([u.asserts ? "asserts " : "", e.call(n, "parameterName"), u.typeAnnotation ? md([" is ", e.call(n, "typeAnnotation")]) : ""]);

          case "TSNonNullExpression":
            return md([e.call(n, "expression"), "!"]);

          case "TSThisType":
            return "this";

          case "TSImportType":
            return md([u.isTypeOf ? "typeof " : "", "import(", e.call(n, u.parameter ? "parameter" : "argument"), ")", u.qualifier ? md([".", e.call(n, "qualifier")]) : "", ih(e, t, n, "typeParameters")]);

          case "TSLiteralType":
            return e.call(n, "literal");

          case "TSIndexedAccessType":
            return md([e.call(n, "objectType"), "[", e.call(n, "indexType"), "]"]);
          ...
          case "TSTypeOperator":
            return md([u.operator, " ", e.call(n, "typeAnnotation")]);

          case "TSMappedType":
            {
              var _r95 = ud(t.originalText, t.locStart(u), t.locEnd(u));

              return bd(md(["{", Ad(md([t.bracketSpacing ? Dd : Ed, u.readonly ? md([$d(u.readonly, "readonly"), " "]) : "", uh(e, t, n), e.call(n, "typeParameter"), u.optional ? $d(u.optional, "?") : "", u.typeAnnotation ? ": " : "", e.call(n, "typeAnnotation"), Sd(o, "")])), Di.printDanglingComments(e, t, !0), t.bracketSpacing ? Dd : Ed, "}"]), {
                shouldBreak: _r95
              });
            }

          case "TSMethodSignature":
            return i.push(u.accessibility ? md([u.accessibility, " "]) : "", u.export ? "export " : "", u.static ? "static " : "", u.readonly ? "readonly " : "", u.computed ? "[" : "", e.call(n, "key"), u.computed ? "]" : "", Lf(e), Qf(e, n, t, !1, !0)), (u.returnType || u.typeAnnotation) && i.push(": ", e.call(n, "returnType"), e.call(n, "typeAnnotation")), bd(md(i));

          case "TSNamespaceExportDeclaration":
            return i.push("export as namespace ", e.call(n, "id")), t.semi && i.push(";"), bd(md(i));

          case "TSEnumDeclaration":
            return u.declare && i.push("declare "), u.modifiers && i.push(uh(e, t, n)), u.const && i.push("const "), i.push("enum ", e.call(n, "id"), " "), 0 === u.members.length ? i.push(bd(md(["{", Di.printDanglingComments(e, t), Ed, "}"]))) : i.push(bd(md(["{", Ad(md([yd, Eh(e, t, "members", n), If(t, "es5") ? "," : ""])), Di.printDanglingComments(e, t, !0), yd, "}"]))), md(i);

          case "TSEnumMember":
            return i.push(e.call(n, "id")), u.initializer && i.push(" = ", e.call(n, "initializer")), md(i);

          case "TSImportEqualsDeclaration":
            return u.isExport && i.push("export "), i.push("import ", e.call(n, "id"), " = ", e.call(n, "moduleReference")), t.semi && i.push(";"), bd(md(i));

          case "TSExternalModuleReference":
            return md(["require(", e.call(n, "expression"), ")"]);
          ...
          case "TSModuleDeclaration":
            {
              ...
              if (_s20) i.push(".");else {
                u.declare && i.push("declare "), i.push(uh(e, t, n));
          ...
          case "TSInferType":
            return md(["infer", " ", e.call(n, "typeParameter")]);

          case "InterpreterDirective":
            return i.push("#!", u.value, yd), fd(t.originalText, u, t.locEnd) && i.push(yd), md(i);

          case "NGRoot":
            return md([].concat(e.call(n, "node"), u.node.comments && 0 !== u.node.comments.length ? md([" //", u.node.comments[0].value.trimEnd()]) : []));
          ...
          case "NGQuotedExpression":
            return md([u.prefix, ": ", u.value.trim()]);
          ...
          case "NGMicrosyntaxExpression":
            return md([e.call(n, "expression"), null === u.alias ? "" : md([" as ", e.call(n, "alias")])]);

          case "NGMicrosyntaxKeyedExpression":
            {
              var _t90 = e.getName(),
                  _r98 = e.getParentNode(),
                  _o43 = Df(u, _t90, _r98) || (1 === _t90 && ("then" === u.key.name || "else" === u.key.name) || 2 === _t90 && "else" === u.key.name && "NGMicrosyntaxKeyedExpression" === _r98.body[_t90 - 1].type && "then" === _r98.body[_t90 - 1].key.name) && "NGMicrosyntaxExpression" === _r98.body[0].type;

              return md([e.call(n, "key"), _o43 ? " " : ": ", e.call(n, "expression")]);
            }

          case "NGMicrosyntaxLet":
            return md(["let ", e.call(n, "key"), null === u.value ? "" : md([" = ", e.call(n, "value")])]);

          case "NGMicrosyntaxAs":
            return md([e.call(n, "key"), " as ", e.call(n, "alias")]);
          ...
          case "TSJSDocFunctionType":
            return md(["function(", "): ", e.call(n, "typeAnnotation")]);
      ...
      if ("ClassMethod" === u.type || "ClassPrivateMethod" === u.type || "ClassProperty" === u.type || "TSAbstractClassProperty" === u.type || "ClassPrivateProperty" === u.type || "MethodDefinition" === u.type || "TSAbstractMethodDefinition" === u.type || "TSDeclareMethod" === u.type) ;else if (u.decorators && u.decorators.length > 0 && !(i && t.locStart(i, {
        ...
        var _r99 = "ClassExpression" === u.type || "ClassDeclaration" === u.type || Xd(u, t) ? yd : Dd;

        e.each(function (e) {
          var t = e.getValue();
          t = t.expression ? t.expression : t.callee, s.push(n(e), _r99);
        }, "decorators"), i && s.unshift(yd);
      } else uf(u) && u.declaration && u.declaration.decorators && u.declaration.decorators.length > 0 && t.locStart(u, {
        ignoreDecorators: !0
      }) > t.locStart(u.declaration.decorators[0]) ? e.each(function (e) {
        var t = "Decorator" === e.getValue().type ? "" : "@";
        s.push(t, n(e), yd);
      }, "declaration", "decorators") : o = kc(e, t);
      var l = [];

      if (o && l.unshift("("), l.push(a), o) {
        var _t91 = e.getValue();

        Jd(_t91) && (l.push(" /*"), l.push(_t91.trailingComments[0].value.trimStart()), l.push("*/"), _t91.trailingComments[0].printed = !0), l.push(")");
      }
    ...
    insertPragma: Id,
    massageAstNode: Cl,
    hasPrettierIgnore: Kd,
    willPrintOwnComments: bh,
        ...
        case "Block":
          {
            if (function (e) {
              ...
              return n.trailing && !rd(t.originalText, t.locStart(n), {
                backwards: !0
              }) ? md([yd, _e115]) : _e115;
            }
    ...
    isBlockComment: Gs.isBlockComment,
    handleComments: {
      ownLine: Gs.handleOwnLineComment,
      endOfLine: Gs.handleEndOfLineComment,
      remaining: Gs.handleRemainingComment
    },
    getGapRegex: Gs.getGapRegex,
    getCommentChildNodes: Gs.getCommentChildNodes
  };
  var _dn$builders10 = dn.builders,
  ...
  var wh = {
    ...
    print: function print(e, t, n) {
      ...
      switch (r.type) {
        case "JsonRoot":
          return vh([e.call(n, "node"), Fh]);

        case "ArrayExpression":
          return 0 === r.elements.length ? "[]" : vh(["[", xh(vh([Fh, Sh(vh([",", Fh]), e.map(n, "elements"))])), Fh, "]"]);

        case "ObjectExpression":
          return 0 === r.properties.length ? "{}" : vh(["{", xh(vh([Fh, Sh(vh([",", Fh]), e.map(n, "properties"))])), Fh, "}"]);

        case "ObjectProperty":
          return vh([e.call(n, "key"), ": ", e.call(n, "value")]);

        case "UnaryExpression":
          return vh(["+" === r.operator ? "" : r.operator, e.call(n, "argument")]);
  ...
  var Th = {
    ...
    bracketSpacing: Bh.bracketSpacing,
    jsxBracketSameLine: {
      since: "0.17.0",
      category: "JavaScript",
      type: "boolean",
  ...
  var hm = function hm(e, t, n) {
    if (["raw", "raws", "sourceIndex", "source", "before", "after", "trailingComma"].forEach(function (e) {
      ...
      if ((n.nodes[0] === e || fm(n.nodes[0]) && n.nodes[1] === e) && (delete t.text, /^\*\s*@(format|prettier)\s*$/.test(e.text))) return null;
  ...
  var Em = {
    ...
    print: function print(e, t) {
      if ("yaml" === e.lang) {
        ...
        return Dm(gm(["---", mm, _r101, _r101 ? mm : "", "---"]));
      }
    }
  };
  ...
  var Sm = new Set(["red", "green", "blue", "alpha", "a", "rgb", "hue", "h", "saturation", "s", "lightness", "l", "whiteness", "w", "blackness", "b", "tint", "shade", "blend", "blenda", "contrast", "hsl", "hsla", "hwb", "hwba"]);
  ...
  var jm = {
    ...
    isMultiplicationNode: Tm,
    isDivisionNode: km,
    isAdditionNode: Nm,
    isSubtractionNode: Om,
    isModuloNode: Pm,
    ...
    isKeyValuePairNode: _m,
    isKeyValuePairInParenGroupNode: Im,
    isSCSSMapItemNode: function isSCSSMapItemNode(e) {
      var t = e.getValue();
      if (0 === t.groups.length) return !1;
      var n = e.getParentNode(1);
      if (!(Im(t) || n && Im(n))) return !1;
      var r = Bm(e, "css-decl");
      return !!(r && r.prop && r.prop.startsWith("$")) || !!Im(n) || "value-func" === n.type;
    },
  ...
  function Jg(e, t, n) {
    ...
    return e.map(function (e) {
      ...
      o !== r.nodes.length - 1 && ("css-comment" === r.nodes[o + 1].type && !qm(t.originalText, t.locStart(r.nodes[o + 1]), {
        backwards: !0
      }) && !Vm(r.nodes[o]) || "css-atrule" === r.nodes[o + 1].type && "else" === r.nodes[o + 1].name && "css-comment" !== r.nodes[o].type ? u.push(" ") : (u.push(t.__isHTMLStyleAttribute ? zm : Jm), Wm(t.originalText, e.getValue(), t.locEnd) && !Vm(r.nodes[o]) && u.push(Jm))), o++;
    }, "nodes"), $m(u);
  }

  var Gg = /(["'])(?:(?!\1)[^\\]|\\[\S\s])*\1/g,
      Hg = new RegExp(Gg.source + "|" + "(".concat(/[$@]?[A-Z_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/g.source, ")?") + "(".concat(/(?:\d*\.\d+|\d+\.?)(?:[Ee][+-]?\d+)?/g.source, ")") + "(".concat(/[A-Za-z]+/g.source, ")?"), "g");
  ...
  var Zg = {
    print: function print(e, t, n) {
      ...
      switch (r.type) {
        ...
        case "css-root":
          {
            ...
            return $m([_u25, _o44 ? " ".concat(_o44) : "", _u25.parts.length && !t.__isHTMLStyleAttribute ? Jm : ""]);
          }
        ...
        case "css-rule":
          return $m([e.call(n, "selector"), r.important ? " !important" : "", r.nodes ? $m([r.selector && "selector-unknown" === r.selector.type && Ug(r.selector.value) ? zm : " ", "{", r.nodes.length > 0 ? Ym($m([Jm, Jg(e, t, n)])) : "", Jm, "}", mg(r) ? ";" : ""]) : ";"]);
        ...
        case "css-decl":
          {
            ...
            var _s21 = wg(r) ? eg(e.call(n, "value")) : e.call(n, "value");

            return !_i47 && Ug(_a36) && (_s21 = Ym($m([Jm, Km(_s21)]))), $m([r.raws.before.replace(/[\s;]/g, ""), ag(e) ? r.prop : ug(r.prop), _a36.startsWith("//") ? " " : "", _a36, r.extend ? "" : " ", fg(t) && r.extend && r.selector ? $m(["extend(", e.call(n, "selector"), ")"]) : "", _s21, r.raws.important ? r.raws.important.replace(/\s*!\s*important/i, " !important") : r.important ? " !important" : "", r.raws.scssDefault ? r.raws.scssDefault.replace(/\s*!default/i, " !default") : r.scssDefault ? " !default" : "", r.raws.scssGlobal ? r.raws.scssGlobal.replace(/\s*!global/i, " !global") : r.scssGlobal ? " !global" : "", r.nodes ? $m([" {", Ym($m([Gm, Jg(e, t, n)])), Gm, "}"]) : Pg(r) && !_u26.raws.semicolon && ";" !== t.originalText[t.locEnd(r) - 1] ? "" : t.__isHTMLStyleAttribute && dg(e, r) ? Qm(";", "") : ";"]);
          }

        case "css-atrule":
          {
            var _u27 = e.getParentNode(),
                _o46 = Og(r) && !_u27.raws.semicolon && ";" !== t.originalText[t.locEnd(r) - 1];

            if (fg(t)) {
              if (r.mixin) return $m([e.call(n, "selector"), r.important ? " !important" : "", _o46 ? "" : ";"]);
              if (r.function) return $m([r.name, $m([e.call(n, "params")]), _o46 ? "" : ";"]);
              if (r.variable) return $m(["@", r.name, ": ", r.value ? $m([e.call(n, "value")]) : "", r.raws.between.trim() ? r.raws.between.trim() + " " : "", r.nodes ? $m(["{", Ym($m([r.nodes.length > 0 ? Gm : "", Jg(e, t, n)])), Gm, "}"]) : "", _o46 ? "" : ";"]);
            }
        ...
        case "media-query-list":
          {
            ...
            }, "nodes"), Hm(Ym(Um(zm, _t94)));
          }

        case "media-query":
          return $m([Um(" ", e.map(n, "nodes")), dg(e, r) ? "" : ","]);

        case "media-type":
          return Kg(Xg(r.value, t));

        case "media-feature-expression":
          return r.nodes ? $m(["(", $m(e.map(n, "nodes")), ")"]) : r.value;

        case "media-feature":
          return ug(Xg(r.value.replace(/ +/g, " "), t));
        ...
        case "media-url":
          return Xg(r.value.replace(/^url\(\s+/gi, "url(").replace(/\s+\)$/gi, ")"), t);

        case "media-unknown":
          return r.value;

        case "selector-root":
          return Hm($m([ig(e, "custom-selector") ? $m([ng(e, "css-atrule").customSelector, zm]) : "", Um($m([",", ig(e, ["extend", "custom-selector", "nest"]) ? zm : Jm]), e.map(n, "nodes"))]));

        case "selector-selector":
          return Hm(Ym($m(e.map(n, "nodes"))));
        ...
        case "selector-tag":
          {
            ...
            return $m([r.namespace ? $m([!0 === r.namespace ? "" : r.namespace.trim(), "|"]) : "", "selector-nesting" === _u28.type ? r.value : Kg(lg(e, r.value) ? r.value.toLowerCase() : r.value)]);
          }
        ...
        case "selector-class":
          return $m([".", Kg(Xg(r.value, t))]);

        case "selector-attribute":
          return $m(["[", r.namespace ? $m([!0 === r.namespace ? "" : r.namespace.trim(), "|"]) : "", r.attribute.trim(), r.operator ? r.operator : "", r.value ? Yg(Xg(r.value.trim(), t), t) : "", r.insensitive ? " i" : "", "]"]);

        case "selector-combinator":
          {
            if ("+" === r.value || ">" === r.value || "~" === r.value || ">>>" === r.value) {
              var _t96 = e.getParentNode(),
                  _n60 = "selector-selector" === _t96.type && _t96.nodes[0] === r ? "" : zm;

              return $m([_n60, r.value, dg(e, r) ? "" : " "]);
            }

            var _n59 = r.value.trim().startsWith("(") ? zm : "",
                _u29 = Kg(Xg(r.value.trim(), t)) || zm;

            return $m([_n59, _u29]);
          }

        case "selector-universal":
          return $m([r.namespace ? $m([!0 === r.namespace ? "" : r.namespace.trim(), "|"]) : "", r.value]);

        case "selector-pseudo":
          return $m([ug(r.value), r.nodes && r.nodes.length > 0 ? $m(["(", Um(", ", e.map(n, "nodes")), ")"]) : ""]);
        ...
        case "selector-unknown":
          {
            var _n61 = ng(e, "css-rule");

            if (_n61 && _n61.isSCSSNesterProperty) return Kg(Xg(ug(r.value), t));
            ...
            if ("value-paren_group" === _u30.type && _o47 && "value-func" === _o47.type && "selector" === _o47.value) {
              ...
              return Ug(_r102) ? $m([Zm, _r102]) : _r102;
            }
        ...
        case "value-comma_group":
          {
            ...
            for (var _n64 = 0; _n64 < r.groups.length; ++_n64) {
              ...
              if ("\\" === _h7.value) continue;
              if (_g(_h7, _m7)) continue;
              if (Mg(_h7) || Lg(_h7) || Rg(_m7) || Lg(_m7) && Tg(_m7) || Rg(_h7) && Tg(_m7)) continue;
              if ("--" === _h7.value && Mg(_m7)) continue;

              var _E3 = Ag(_h7),
                  _C3 = Ag(_m7);

              if ((_E3 && Mg(_m7) || _C3 && Rg(_h7)) && Tg(_m7)) continue;
              if (og(e, "calc") && (Cg(_h7) || Cg(_m7) || bg(_h7) || bg(_m7)) && Tg(_m7)) continue;

              var _b2 = (Cg(_h7) || bg(_h7)) && 0 === _n64 && ("value-number" === _m7.type || _m7.isHex) && _u31 && $g(_u31) && !Tg(_m7),
                  _A2 = _g6 && "value-func" === _g6.type || _g6 && qg(_g6) || "value-func" === _h7.type || qg(_h7),
                  _v2 = "value-func" === _m7.type || qg(_m7) || _o49 && "value-func" === _o49.type || _o49 && qg(_o49);

              if (yg(_m7) || yg(_h7) || og(e, "calc") || _b2 || !(Eg(_m7) && !_A2 || Eg(_h7) && !_v2 || Cg(_m7) && !_A2 || Cg(_h7) && !_v2 || bg(_m7) || bg(_h7)) || !(Tg(_m7) || _E3 && (!_o49 || _o49 && Ag(_o49)))) if (jg(_h7)) {
                ...
                _c14.push(Jm);
              } else _s22 && (Dg(_m7) || gg(_m7) || Sg(_m7) || vg(_h7) || Fg(_h7)) || _i48 && "namespace" === _i48.name.toLowerCase() ? _c14.push(" ") : _a37 ? _h7.source && _m7.source && _h7.source.start.line !== _m7.source.start.line ? (_c14.push(Jm), _f7 = !0) : _c14.push(" ") : _C3 ? _c14.push(" ") : _m7 && "..." === _m7.value || _c14.push(zm);
            }
        ...
        case "value-paren_group":
          {
            ...
            if (_u32 && xg(_u32) && (1 === r.groups.length || r.groups.length > 0 && "value-comma_group" === r.groups[0].type && r.groups[0].groups.length > 0 && "value-word" === r.groups[0].groups[0].type && r.groups[0].groups[0].value.startsWith("data:"))) return $m([r.open ? e.call(n, "open") : "", Um(",", e.map(n, "groups")), r.close ? e.call(n, "close") : ""]);
            ...
            if (!r.open) {
              ...
              for (var _e120 = 0; _e120 < _t98.length; _e120++) {
                0 !== _e120 && _r103.push($m([",", zm])), _r103.push(_t98[_e120]);
              }
            ...
            return Hm($m([r.open ? e.call(n, "open") : "", Ym($m([Gm, Um($m([",", zm]), e.map(function (e) {
              var t = e.getValue(),
                  r = n(e);
              return kg(t) && "value-comma_group" === t.type && t.groups && t.groups[2] && "value-paren_group" === t.groups[2].type ? (r.contents.contents.parts[1] = Hm(r.contents.contents.parts[1]), Hm(Km(r))) : r;
            }, "groups"))])), Qm(!_i49 && pg(t.parser, t.originalText) && _o50 && zg(t) ? "," : ""), Gm, r.close ? e.call(n, "close") : ""]), {
              shouldBreak: _o50
            });
          }

        case "value-func":
          return $m([r.value, ig(e, "supports") && Wg(r) ? " " : "", e.call(n, "group")]);

        case "value-paren":
          return r.value;

        case "value-number":
          return $m([Qg(r.value), ug(r.unit)]);

        case "value-operator":
          return r.value;

        case "value-word":
          return r.isColor && r.isHex || cg(r.value) ? r.value.toLowerCase() : r.value;
        ...
        case "value-colon":
          {
            ...
            return $m([r.value, _u33 && "\\" === _u33.value[_u33.value.length - 1] || og(e, "url") ? "" : zm]);
          }
        ...
        case "value-string":
          return Lm(r.raws.quote + r.value + r.raws.quote, t);
  ...
  var _dn$builders14 = dn.builders,
  ...
  function UD(e, t) {
    var n = e.getValue();
    return wD(["<", n.tag, zD(e, t), Dy(n), GD(n)]);
  }

  function zD(e, t) {
    var n = e.getValue();
    return ND(wD([n.attributes.length ? PD : "", OD(PD, e.map(t, "attributes")), n.modifiers.length ? PD : "", OD(PD, e.map(t, "modifiers")), n.comments.length ? PD : "", OD(PD, e.map(t, "comments"))]));
  }
  ...
  function ny(e, t) {
    var n = e.getValue();
    return BD(wD([YD(n), hy(e, t), Dy(n.program), _D, KD(n)]));
  }
  ...
  function uy(e, t) {
    var n = e.getParentNode(1);
    return wD([ey(n), "else ", hy(e, t), ty(n)]);
  }

  function oy(e, t) {
    var n = e.getValue();
    return wD([ay(n) ? _D : TD, QD(n), e.call(t, "path"), ZD(n)]);
  }
  ...
  function dy(e, t) {
    ...
    return wD([i.quote, s, i.quote]);
  }

  function fy(e, t) {
    var n = my(e, t),
        r = gy(e, t);
    return r ? ND(wD([n, PD, BD(r)])) : n;
  }

  function hy(e, t) {
    var n = my(e, t),
        r = gy(e, t);
    return r ? ND(BD(wD([n, PD, r]))) : n;
  }
  ...
  var Ey = {
    print: function print(e, t, n) {
      ...
      if (MD(e)) {
        var _e121 = yy(t.originalText, r.loc.start.line - 1, r.loc.start.column),
            _n68 = yy(t.originalText, r.loc.end.line - 1, r.loc.end.column);
      ...
      switch (r.type) {
        ...
        case "Program":
        case "Template":
          return BD(wD(e.map(n, "body")));

        case "ElementNode":
          {
            var _u34 = LD(e, ["ElementNode"]) ? TD : "";

            if (WD(r)) return wD([BD(UD(e, n)), _u34]);
        ...
        case "BlockStatement":
          {
            ...
            return wD(_u35 ? [uy(e, n), sy(e, n), ly(e, n)] : [ny(e, n), BD(wD([sy(e, n), ly(e, n), oy(e, n)]))]);
          }

        case "ElementModifierStatement":
          return BD(wD(["{{", hy(e, n), _D, "}}"]));

        case "MustacheStatement":
          {
            var _t101 = qD(e, ["AttrNode", "ConcatStatement"]),
                _u36 = qD(e, ["ElementNode"]) && 0 === r.hash.pairs.length && function (e) {
              return 0 === e.params.length;
            }(r),
                _o53 = _t101 || _u36;

            return BD(wD([HD(r), _o53 ? ND(_D) : "", hy(e, n), _D, XD(r)]));
          }

        case "SubExpression":
          return BD(wD(["(", fy(e, n), _D, ")"]));

        case "AttrNode":
          {
            var _u37 = "TextNode" === r.value.type;

            if (_u37 && "" === r.value.chars && r.value.loc.start.column === r.value.loc.end.column) return wD([r.name]);

            var _o54 = e.call(n, "value"),
                _a39 = _u37 ? dy(_o54.parts.join(), t) : _o54;

            return wD([r.name, "=", _a39]);
          }
        ...
        case "ConcatStatement":
          {
            ...
            return wD([_r104].concat(_toConsumableArray(e.map(function (e) {
              return n(e);
            }, "parts")), [_r104]));
          }

        case "Hash":
          return wD([OD(PD, e.map(n, "pairs"))]);

        case "HashPair":
          return wD([r.key, "=", e.call(n, "value")]);
        ...
        case "TextNode":
          {
            ...
            if ((_n69 || _u38) && _o55 && qD(e, ["Block", "ElementNode", "Template"])) return "";
            _o55 && _a40 ? (_i50 = Math.min(_a40, _t102), _s23 = 0) : (LD(e, ["BlockStatement", "ElementNode"]) && (_s23 = Math.max(_s23, 1)), VD(e, ["BlockStatement", "ElementNode"]) && (_i50 = Math.max(_i50, 1)));
            ...
            if (e.stack.includes("attributes")) {
              ...
              }(e, "class")) return wD([r.chars]);
              var _n70 = "",
                  _u39 = "";
              return qD(e, ["ConcatStatement"]) && (VD(e, ["MustacheStatement"]) && (_n70 = " "), LD(e, ["MustacheStatement"]) && (_u39 = " ")), wD([].concat(_toConsumableArray(py(_i50, _t102)), [r.chars.replace(/^\s+/g, _n70).replace(/\s+$/, _u39)], _toConsumableArray(py(_s23, _t102))));
            }

            var _l20 = "",
                _c15 = "";
            0 === _s23 && LD(e, ["MustacheStatement"]) && (_c15 = " "), 0 === _i50 && VD(e, ["MustacheStatement"]) && (_l20 = " "), _n69 && (_i50 = 0, _l20 = ""), _u38 && (_s23 = 0, _c15 = "");
            var _p11 = r.chars;
            return _p11.startsWith("{{") && _p11.includes("}}") && (_p11 = "\\" + _p11), wD([].concat(_toConsumableArray(py(_i50, _t102)), [_p11.replace(/^\s+/g, _l20).replace(/\s+$/, _c15)], _toConsumableArray(py(_s23, _t102))));
          }
  ...
  function jy(e, t, n) {
    ...
    var r = Sy(By, e.map(t, "directives"));
    return "FragmentDefinition" === n.kind || "OperationDefinition" === n.kind ? ky(xy([By, r])) : xy([" ", ky(Ny(xy([Ty, r])))]);
  }
  ...
  function My(e, t, n) {
    ...
    return e.map(function (e, u) {
      var o = n(e);
      return _y(t.originalText, e.getValue(), t.locEnd) && u < r - 1 ? xy([o, wy]) : o;
    });
  }
      ...
      switch (r.kind) {
        ...
        case "OperationDefinition":
          {
            ...
            return xy([_u41 ? r.operation : "", _u41 && _o57 ? xy([" ", e.call(n, "name")]) : "", r.variableDefinitions && r.variableDefinitions.length ? ky(xy(["(", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.map(n, "variableDefinitions"))])), Ty, ")"])) : "", jy(e, n, r), r.selectionSet && (_u41 || _o57) ? " " : "", e.call(n, "selectionSet")]);
          }

        case "FragmentDefinition":
          return xy(["fragment ", e.call(n, "name"), r.variableDefinitions && r.variableDefinitions.length ? ky(xy(["(", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.map(n, "variableDefinitions"))])), Ty, ")"])) : "", " on ", e.call(n, "typeCondition"), jy(e, n, r), " ", e.call(n, "selectionSet")]);
        ...
        case "Field":
          return ky(xy([r.alias ? xy([e.call(n, "alias"), ": "]) : "", e.call(n, "name"), r.arguments.length > 0 ? ky(xy(["(", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.call(function (e) {
            return My(e, t, n);
          }, "arguments"))])), Ty, ")"])) : "", jy(e, n, r), r.selectionSet ? " " : "", e.call(n, "selectionSet")]));
        ...
        case "Variable":
          return xy(["$", e.call(n, "name")]);

        case "ListValue":
          return ky(xy(["[", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.map(n, "values"))])), Ty, "]"]));

        case "ObjectValue":
          return ky(xy(["{", t.bracketSpacing && r.fields.length > 0 ? " " : "", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.map(n, "fields"))])), Ty, Oy("", t.bracketSpacing && r.fields.length > 0 ? " " : ""), "}"]));

        case "ObjectField":
        case "Argument":
          return xy([e.call(n, "name"), ": ", e.call(n, "value")]);
        ...
        case "VariableDefinition":
          return xy([e.call(n, "variable"), ": ", e.call(n, "type"), r.defaultValue ? xy([" = ", e.call(n, "defaultValue")]) : "", jy(e, n, r)]);
        ...
        case "FieldDefinition":
          return xy([e.call(n, "description"), r.description ? wy : "", e.call(n, "name"), r.arguments.length > 0 ? ky(xy(["(", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.call(function (e) {
            return My(e, t, n);
          }, "arguments"))])), Ty, ")"])) : "", ": ", e.call(n, "type"), jy(e, n, r)]);
        ...
        case "DirectiveDefinition":
          return xy([e.call(n, "description"), r.description ? wy : "", "directive ", "@", e.call(n, "name"), r.arguments.length > 0 ? ky(xy(["(", Ny(xy([Ty, Sy(xy([Oy("", ", "), Ty]), e.call(function (e) {
            return My(e, t, n);
          }, "arguments"))])), Ty, ")"])) : "", r.repeatable ? " repeatable" : "", xy([" on ", Sy(" | ", e.map(n, "locations"))])]);
        ...
        case "EnumValueDefinition":
          return xy([e.call(n, "description"), r.description ? wy : "", e.call(n, "name"), jy(e, n, r)]);

        case "InputValueDefinition":
          return xy([e.call(n, "description"), r.description ? r.description.block ? wy : By : "", e.call(n, "name"), ": ", e.call(n, "type"), r.defaultValue ? xy([" = ", e.call(n, "defaultValue")]) : "", jy(e, n, r)]);
        ...
        case "OperationTypeDefinition":
          return xy([e.call(n, "operation"), ": ", e.call(n, "type")]);
        ...
        case "FragmentSpread":
          return xy(["...", e.call(n, "name"), jy(e, n, r)]);

        case "InlineFragment":
          return xy(["...", r.typeCondition ? xy([" on ", e.call(n, "typeCondition")]) : "", jy(e, n, r), " ", e.call(n, "selectionSet")]);

        case "UnionTypeExtension":
        case "UnionTypeDefinition":
          return ky(xy([e.call(n, "description"), r.description ? wy : "", ky(xy(["UnionTypeExtension" === r.kind ? "extend " : "", "union ", e.call(n, "name"), jy(e, n, r), r.types.length > 0 ? xy([" =", Oy("", " "), Ny(xy([Oy(xy([By, "  "])), Sy(xy([By, "| "]), e.map(n, "types"))]))]) : ""]))]));

        case "ScalarTypeExtension":
        case "ScalarTypeDefinition":
          return xy([e.call(n, "description"), r.description ? wy : "", "ScalarTypeExtension" === r.kind ? "extend " : "", "scalar ", e.call(n, "name"), jy(e, n, r)]);

        case "NonNullType":
          return xy([e.call(n, "type"), "!"]);
  ...
  var Zy = {
      ...
      return ("preserve" === t.proseWrap ? e : e.replace(new RegExp("(".concat(zy, ")\n(").concat(zy, ")"), "g"), "$1$2")).split(/([\t\n ]+)/).forEach(function (e, t, u) {
        t % 2 != 1 ? (0 !== t && t !== u.length - 1 || "" !== e) && e.split(new RegExp("(".concat(zy, ")"))).forEach(function (e, t, n) {
          (0 !== t && t !== n.length - 1 || "" !== e) && (t % 2 != 0 ? r(Ky.test(e) ? {
            ...
            type: "word",
            value: e,
            kind: Yy.test(e) ? "k-letter" : "cj-letter",
            ...
            value: e,
            kind: "non-cjk",
            hasLeadingPunctuation: Ky.test(e[0]),
            hasTrailingPunctuation: Ky.test(Uy(e))
          }));
        }) : n.push({
          type: "whitespace",
          value: /\n/.test(e) ? "\n" : " "
    ...
    hasGitDiffFriendlyOrderedList: function hasGitDiffFriendlyOrderedList(e, t) {
      ...
      var n = Number(Qy(e.children[0], t.originalText).numberText),
          r = Number(Qy(e.children[1], t.originalText).numberText);

      if (0 === n && e.children.length > 2) {
        var _n73 = Number(Qy(e.children[2], t.originalText).numberText);
    ...
    INLINE_NODE_TYPES: Hy,
    INLINE_NODE_WRAPPER_TYPES: Xy,
    ...
    if ("code" === u.type && null !== u.lang) {
      ...
      if (_o58) {
        var _e126 = r.__inJsTemplate ? "~" : "`",
            _t104 = _e126.repeat(Math.max(3, tE(u.value, _e126) + 1)),
            _a42 = n(iE(u, r.originalText), {
          parser: _o58
        }, {
          stripTrailingHardline: !0
        });

        return uE(rE([_t104, u.lang, u.meta ? " " + u.meta : "", nE, oE(_a42), nE, _t104]));
      }
    }
  ...
  var yE = function yE(e, t) {
    return e = function (e) {
      ...
      return hE(e, function (e, n, _ref33) {
      ...
      function r(e) {
        ...
        if (fE(r, t.originalText).leadingSpaces.length > 1) return !0;
        var o = n(r);
        if (-1 === o) return !1;
        if (1 === e.children.length) return o % t.tabWidth == 0;
        if (o !== n(u)) return !1;
        if (o % t.tabWidth == 0) return !0;
        return fE(u, t.originalText).leadingSpaces.length > 1;
      }
    }(e = function (e, t) {
      ...
      return hE(e, function (e) {
        return "text" !== e.type ? e : Object.assign({}, e, {
          value: "*" !== e.value && "_" !== e.value && "$" !== e.value && gE.test(e.value) && e.position.end.offset - e.position.start.offset !== e.value.length ? t.originalText.slice(e.position.start.offset, e.position.end.offset) : e.value
        });
      });
    }(e, t))), t), t), t)));
  };
  ...
  function YE(e, t, n, r) {
    ...
    return FE([o, nC(e, t, n, {
      processor: function processor(e, u) {
        if (0 === u && "list" !== e.getValue().type) return PE(" ".repeat(o.length), e.call(n));
        var a = " ".repeat((i = t.tabWidth - r.length, l = 3, i < (s = 0) ? s : i > l ? l : i));
        var i, s, l;
        return FE([a, PE(a, e.call(n))]);
      }
    })]);
  }
  ...
  function eC(e, t, n) {
    ...
    var r = "always" === n.proseWrap && !ZE(e, HE);
    return "" !== t ? r ? SE : " " : r ? kE : "";
  }
  ...
  function tC(e, t, n) {
    ...
    return o.forEach(function (e, t) {
      ...
      processor: function processor(e, u) {
        if (0 !== r.length) {
          var _e128 = r[0];
          if (u === _e128.start.index) return FE([o[_e128.start.index].value, t.originalText.slice(_e128.start.offset, _e128.end.offset), o[_e128.end.index].value]);
      ...
      if (!1 !== u) {
        ...
        (function (e, t) {
          var n = 0 === t.parts.length,
              ...
              u = "html" === e.type && zE.includes(t.parentNode.type);
          return n || r || u;
        })(r, _e129) || (i.push(TE), s && GE.has(s.type) || (function (e, t) {
          ...
          return u || !(n || r || o || a || i);
        }(r, _e129) || oC(r, _e129)) && i.push(TE), oC(r, _e129) && i.push(TE)), i.push(u), s = r;
      }
    }, "children"), u(i);
  }
  ...
  var sC = {
    ...
    print: function print(e, t, n) {
      var r = e.getValue();
      if (function (e) {
        var t = ZE(e, ["linkReference", "imageReference"]);
      ...
      switch (r.type) {
        ...
        case "root":
          return 0 === r.children.length ? "" : FE([jE(tC(e, t, n)), GE.has(rC(r).type) ? "" : TE]);
        ...
        case "word":
          {
            var _n75 = r.value.replace(/[$*]/g, "\\$&").replace(new RegExp(["(^|".concat($E, ")(_+)"), "(_+)(".concat($E, "|$)")].join("|"), "g"), function (e, t, n, r, u) {
        ...
        case "emphasis":
          {
            ...
            if (JE(r.children[0], t)) _u45 = t.originalText[r.position.start.offset];else {
              var _t107 = e.getParentNode(),
                  _n77 = _t107.children.indexOf(r),
                  _o61 = _t107.children[_n77 - 1],
                  _a44 = _t107.children[_n77 + 1];

              _u45 = _o61 && "sentence" === _o61.type && _o61.children.length > 0 && "word" === EE(_o61.children).type && !EE(_o61.children).hasTrailingPunctuation || _a44 && "sentence" === _a44.type && _a44.children.length > 0 && "word" === _a44.children[0].type && !_a44.children[0].hasLeadingPunctuation || ZE(e, "emphasis") ? "*" : "_";
            }
        ...
        case "inlineCode":
          {
            var _e130 = CE(r.value, "`"),
                _t108 = "`".repeat(_e130 || 1),
                _n78 = _e130 && !/^\s/.test(r.value) ? " " : "";

            return FE([_t108, _n78, r.value, _n78, _t108]);
          }
        ...
        case "link":
          switch (t.originalText[r.position.start.offset]) {
            ...
            case "[":
              return FE(["[", nC(e, t, n), "](", aC(r.url, ")"), iC(r.title, t), ")"]);
        ...
        case "image":
          return FE(["![", r.alt || "", "](", aC(r.url, ")"), iC(r.title, t), ")"]);

        case "blockquote":
          return FE(["> ", PE("> ", nC(e, t, n))]);

        case "heading":
          return FE(["#".repeat(r.depth) + " ", nC(e, t, n)]);
        ...
        case "code":
          {
            if (r.isIndented) {
              ...
              return PE(_e133, FE([_e133, FE(LE(r.value, TE))]));
            }

            var _e132 = t.__inJsTemplate ? "~" : "`",
                _n80 = _e132.repeat(Math.max(3, bE(r.value, _e132) + 1));

            return FE([_n80, r.lang || "", r.meta ? " " + r.meta : "", TE, FE(LE(qE(r, t.originalText), TE)), TE, _n80]);
          }

        case "html":
          {
            var _t109 = e.getParentNode(),
                _n81 = "root" === _t109.type && EE(_t109.children) === r ? r.value.trimEnd() : r.value,
                _u46 = /^<!--[\S\s]*-->$/.test(_n81);

            return FE(LE(_n81, _u46 ? TE : BE(wE)));
          }
        ...
        case "list":
          {
            ...
            return nC(e, t, n, {
              processor: function processor(e, a) {
                ...
                return 2 === s.children.length && "html" === s.children[1].type && s.children[0].position.start.column !== s.children[1].position.start.column ? FE([i, YE(e, t, n, i)]) : FE([i, PE(" ".repeat(i.length), YE(e, t, n, i))]);
              }
            });
          }
        ...
        case "thematicBreak":
          {
            ...
            if (-1 === _t110) return "---";
            return KE(e.getParentNode(_t110), e.getParentNode(_t110 + 1)) % 2 == 0 ? "***" : "---";
          }

        case "linkReference":
          return FE(["[", nC(e, t, n), "]", "full" === r.referenceType ? FE(["[", r.identifier, "]"]) : "collapsed" === r.referenceType ? "[]" : ""]);

        case "imageReference":
          switch (r.referenceType) {
            case "full":
              return FE(["![", r.alt || "", "][", r.identifier, "]"]);

            default:
              return FE(["![", r.alt, "]", "collapsed" === r.referenceType ? "[]" : ""]);
          }

        case "definition":
          {
            var _e134 = "always" === t.proseWrap ? SE : " ";

            return IE(FE([FE(["[", r.identifier, "]:"]), _E(FE([_e134, aC(r.url), null === r.title ? "" : FE([_e134, iC(r.title, t, !1)])]))]));
          }
        ...
        case "footnoteDefinition":
          {
            ...
            return FE(["[^", r.identifier, "]: ", _o63 ? nC(e, t, n) : IE(FE([PE(" ".repeat(4), nC(e, t, n, {
        ...
        case "table":
          return function (e, t, n) {
            ...
            if ("never" !== t.proseWrap) return FE([vE, i]);
            var s = xE(r, [c(o[0], !0), l(!0), xE(r, o.slice(1).map(function (e) {
              return c(e, !0);
            }))]);
            return FE([vE, IE(NE(s, i))]);
            ...
            function p(e, t) {
              var n = t - AE(e);
              return FE([e, " ".repeat(n)]);
            }

            function d(e, t) {
              var n = t - AE(e);
              return FE([" ".repeat(n), e]);
            }
        ...
        case "liquidNode":
          return FE(LE(r.value, TE));

        case "importExport":
        case "jsx":
          return FE([r.value, TE]);

        case "math":
          return FE(["$$", TE, r.value ? FE([FE(LE(r.value, TE)), TE]) : "", "$$"]);
    ...
    hasPrettierIgnore: function hasPrettierIgnore(e) {
      var t = +e.getName();
      return 0 !== t && "next" === uC(e.getParentNode().children[t - 1]);
    },
    insertPragma: dE.insertPragma
  },
      lC = {
    proseWrap: Bh.proseWrap,
    singleQuote: Bh.singleQuote
  },
      cC = ["pandoc"],
  ...
  var CA = new Set(["template", "style", "script"]);
  ...
  var FA = {
      ...
      var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
        ...
        try {
          for (_iterator42.s(); !(_step42 = _iterator42.n()).done;) {
            ...
            if (!tA.has(_n83[0])) return 0;
            var _e135 = rA(_n83).length;
    ...
    isVueCustomBlock: bA,
    isVueNonHtmlBlock: vA,
    isDanglingSpaceSensitiveNode: function isDanglingSpaceSensitiveNode(e) {
      return !(t = e.cssDisplay, gA(t) || "inline-block" === t || iA(e));
      var t;
    },
    isIndentationSensitiveNode: sA,
    isLeadingSpaceSensitiveNode: function isLeadingSpaceSensitiveNode(e, t) {
      var n = function () {
        ...
        if (DA(e.parent)) return !0;
        if (!e.prev && ("root" === e.parent.type || DA(e) && e.parent || iA(e.parent) || bA(e.parent, t) || (n = e.parent.cssDisplay, gA(n) || "inline-block" === n))) return !1;
        var n;
  ...
  var xA = FA.htmlTrim,
    ...
    return e.map(function (e) {
      if (!e.children) return e;
      if (0 === e.children.length || 1 === e.children.length && "text" === e.children[0].type && 0 === xA(e.children[0].value).length) return e.clone({
        children: [],
    ...
    return e.map(function (e) {
      return e.children ? 0 === e.children.length ? e.clone({
        isDanglingSpaceSensitive: kA(e)
      }) : e.clone({
        children: e.children.map(function (e) {
          return Object.assign({}, e, {
            isLeadingSpaceSensitive: OA(e, t),
            isTrailingSpaceSensitive: PA(e, t)
          });
        }).map(function (e, t, n) {
          return Object.assign({}, e, {
  ...
  var jA = function jA(e, t) {
    var _iterator44 = _createForOfIteratorHelper(IA),
        _step44;
  ...
  var qA = {
    ...
    printVueFor: function printVueFor(e, t) {
      ...
      return LA([RA(t("function _(".concat(n, ") {}"), {
        parser: "babel",
  ...
  var JA = {
    printImgSrcset: function printImgSrcset(e) {
      ...
      return UA(WA([",", zA]), i.map(function (e, t) {
        var n = [e],
            r = l[t];
  ...
  function jv(e) {
    var t = XA(e);
    return 0 === t.length ? "" : 1 === t.length ? t[0] : GA.concat(t);
  }

  function Mv(e, t, n) {
    var r = e.getValue();
    if (hv(r)) return jv([QA, jv(e.map(function (e) {
      var t = e.getValue(),
          n = t.prev ? a(t.prev, t) : "";
      return jv([n ? jv([n, gv(t.prev) ? nv : ""]) : "", o(e)]);
    }, "children"))]);
    ...
    return jv(e.map(function (e, t) {
      ...
      if (Fv(n)) {
        if (n.prev && Fv(n.prev)) {
          ...
          if (_t116) return gv(n.prev) ? jv([nv, nv, o(e)]) : jv([_t116, o(e)]);
        }
      ...
      var r = [],
          ...
          c = n.prev ? a(n.prev, n) : "",
          p = n.next ? a(n, n.next) : "";
      return c && (gv(n.prev) ? r.push(nv, nv) : c === nv ? r.push(nv) : Fv(n.prev) ? i.push(c) : i.push(rv("", sv, {
        groupId: u[t - 1]
      }))), p && (gv(n) ? Fv(n.next) && l.push(nv, nv) : p === nv ? Fv(n.next) && l.push(nv) : s.push(p)), jv([].concat(r, tv(jv([jv(i), tv(jv([o(e), jv(s)]), {
        id: u[t]
      })])), l));
    }, "children"));
    ...
    function o(e) {
      var r = e.getValue();
      return Ev(r) ? jv([].concat(Kv(r, t), YA(t.originalText.slice(t.locStart(r) + (r.prev && Jv(r.prev) ? eF(r).length : 0), t.locEnd(r) - (r.next && Hv(r.next) ? rF(r, t).length : 0)), iv), Zv(r, t))) : n(e);
    }
  ...
  function Lv(e, t) {
    ...
    e.firstChild && Gv(e.firstChild) && (n -= tF(e).length);
    var r = e.endSourceSpan.start.offset;
    return e.lastChild && Yv(e.lastChild) ? r += nF(e, t).length : Xv(e) && (r -= rF(e.lastChild, t).length), t.originalText.slice(n, r);
  }

  function Rv(e, t, n) {
    var r = e.getValue();
    if (!r.attrs || 0 === r.attrs.length) return r.isSelfClosing ? " " : "";
    var u = r.prev && "comment" === r.prev.type && yv(r.prev.value),
      ...
      return !1;
        ...
        a = e.map(function (e) {
      var r = e.getValue();
      return o(r) ? jv(YA(t.originalText.slice(t.locStart(r), t.locEnd(r)), iv)) : n(e);
    }, "attrs"),
        i = "element" === r.type && "script" === r.fullName && 1 === r.attrs.length && "src" === r.attrs[0].fullName && 0 === r.children.length,
        s = [uv(jv([i ? " " : av, ov(av, a)]))];
    return r.firstChild && Gv(r.firstChild) || r.isSelfClosing && Xv(r.parent) || i ? s.push(r.isSelfClosing ? " " : "") : s.push(r.isSelfClosing ? av : sv), jv(s);
  }

  function qv(e, t, n) {
    var r = e.getValue();
    return jv([Vv(r, t), Rv(e, t, n), r.isSelfClosing ? "" : Wv(r)]);
  }
  ...
  function nF(e, t) {
    if (e.isSelfClosing, Sv(e, t)) return "";
  ...
  var oF = {
    ...
    print: function print(e, t, n) {
      ...
      switch (r.type) {
        case "front-matter":
          return jv(YA(r.raw, iv));

        case "root":
          return t.__onHtmlRoot && t.__onHtmlRoot(r), GA.concat([tv(Mv(e, t, n)), nv]);

        case "element":
        case "ieConditionalComment":
          {
            if (wv(r, t)) return jv([].concat(Kv(r, t), tv(qv(e, t, n)), YA(Lv(r, t), iv), $v(r, t), Zv(r, t)));
            ...
            return jv([tv(jv([tv(qv(e, t, n), {
              id: _a50
            }), 0 === r.children.length ? r.hasDanglingSpaces && r.isDanglingSpaceSensitive ? av : "" : jv([mv(r) ? QA : "", (u = jv([_o68 ? rv(sv, "", {
              groupId: _a50
            }) : r.firstChild.hasLeadingSpaces && r.firstChild.isLeadingSpaceSensitive ? av : "text" === r.firstChild.type && r.isWhitespaceSensitive && r.isIndentationSensitive ? ZA(sv) : sv, Mv(e, t, n)]), _o68 ? rv(uv(u), u, {
              groupId: _a50
            }) : !vv(r) && !bv(r, t) || "root" !== r.parent.type || "vue" !== t.parser || t.vueIndentScriptAndStyle ? uv(u) : u), (r.next ? Hv(r.next) : Xv(r.parent)) ? r.lastChild.hasTrailingSpaces && r.lastChild.isTrailingSpaceSensitive ? " " : "" : _o68 ? rv(sv, "", {
              groupId: _a50
            }) : r.lastChild.hasTrailingSpaces && r.lastChild.isTrailingSpaceSensitive ? av : ("comment" === r.lastChild.type || "text" === r.lastChild.type && r.isWhitespaceSensitive && r.isIndentationSensitive) && new RegExp("\\n[\\t ]{".concat(t.tabWidth * dv(e, function (e) {
        ...
        case "interpolation":
          return jv([Vv(r, t), jv(e.map(n, "children")), zv(r, t)]);
        ...
        case "text":
          if ("interpolation" === r.parent.type) {
            ...
            return jv([jv(YA(_n91, iv)), _t117 ? nv : ""]);
          }

          return ev(XA([].concat(Kv(r, t), uF(r), Zv(r, t))));

        case "docType":
          return jv([tv(jv([Vv(r, t), " ", r.value.replace(/^html\b/i, "html").replace(/\s+/g, " ")])), zv(r, t)]);

        case "comment":
          return jv([Kv(r, t), jv(YA(t.originalText.slice(t.locStart(r), t.locEnd(r)), iv)), Zv(r, t)]);

        case "attribute":
          {
            if (null === r.value) return r.rawName;

            var _e139 = Bv(r.value),
                _t118 = pv(_e139, "'") < pv(_e139, '"') ? "'" : '"';

            return jv([r.rawName, jv(["=", _t118, jv(YA('"' === _t118 ? _e139.replace(/"/g, "&quot;") : _e139.replace(/'/g, "&apos;"), iv)), _t118])]);
          }
    ...
    embed: function embed(e, t, n, r) {
      ...
      switch (u.type) {
        case "element":
          if (vv(u) || "interpolation" === u.type) return;

          if (!u.isSelfClosing && Av(u, r)) {
            var _o69 = Cv(u, r);
            ...
            return _i55 || (_s26 = n(lv(_a51), {
              parser: _o69
            }, {
              stripTrailingHardline: !0
            }), _i55 = "" === _s26), jv([Kv(u, r), tv(qv(e, r, t)), _i55 ? "" : nv, _s26, _i55 ? "" : nv, $v(u, r), Zv(u, r)]);
          }
        ...
        case "text":
          if (vv(u.parent)) {
            var _e140 = Cv(u.parent);

            if (_e140) {
              var _t119 = "markdown" === _e140 ? fv(u.value.replace(/^[^\S\n]*?\n/, "")) : u.value,
                  _o70 = {
                parser: _e140
              };
              ...
              return GA.concat([jv([QA, Kv(u, r), n(_t119, _o70, {
                stripTrailingHardline: !0
              }), Zv(u, r)])]);
            }
          } else if ("interpolation" === u.parent.type) return jv([uv(jv([av, n(u.value, Object.assign({
            ...
            stripTrailingHardline: !0
          })])), u.parent.next && Hv(u.parent.next) ? " " : av]);
        ...
        case "attribute":
          {
            if (!u.value) break;
            if (/^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(r.originalText.slice(u.valueSpan.start.offset, u.valueSpan.end.offset))) return jv([u.rawName, "=", u.value]);
            ...
            var _e142 = function (e, t, n) {
              ...
              if ("srcset" === e.fullName && ("img" === e.parent.fullName || "source" === e.parent.fullName)) return s(_v(u()));

              if ("class" === e.fullName && !n.parentParser) {
                var _e143 = u();

                if (!_e143.includes("{{")) return Iv(_e143);
              }
              ...
              if ("vue" === n.parser) {
                if ("v-for" === e.fullName) return Nv(u(), c);
                if ("slot-scope" === e.fullName) return Ov(u(), c);
                var _t121 = ["^:", "^v-bind:"],
                    _n92 = ["^v-", "^#"];
                ...
                if (r(["^@", "^v-on:"])) {
                  ...
                  return l(c(_e145, {
                    parser: Pv(_e145) ? "__js_expression" : "__vue_event_binding"
                  }));
                }
              ...
              if ("angular" === n.parser) {
                ...
                if (r(_a52)) {
                  ...
                  return s(ev(uF(e, _t123)), !_t123.includes("@@"));
                }
                ...
                if (_i56.test(_p12)) {
                  ...
                  return _p12.split(_i56).forEach(function (n, r) {
                    if (r % 2 == 0) _e146.push(jv(YA(n, iv)));else try {
                      _e146.push(tv(jv(["{{", uv(jv([av, _t122(n, {
                        parser: "__ng_interpolation",
                        __isInHtmlInterpolation: !0
                      })])), av, "}}"])));
                    } catch (t) {
                      _e146.push("{{", jv(YA(n, iv)), "}}");
                    }
                  }), tv(jv(_e146));
                }
              }
            ...
            if (_e142) return jv([u.rawName, '="', tv(HA(_e142, function (e) {
  ...
  var wF = {
    ...
    getBlockValueLineContents: function getBlockValueLineContents(e, _ref39) {
      ...
      function s(t) {
        if ("keep" === e.chomping) return 0 === yF(t).length ? t.slice(0, -1) : t;
        var r = 0;
    ...
    hasPrettierIgnore: function hasPrettierIgnore(e) {
      ...
      if ("documentBody" === t.type) {
        ...
        return xF(_t125.head) && CF(yF(_t125.head.endComments));
      }

      return bF(t) && CF(yF(t.leadingComments));
    },
    hasLeadingComments: bF,
    hasMiddleComments: AF,
    hasIndicatorComment: vF,
    hasTrailingComment: FF,
    hasEndComments: xF
  };
  var BF = dn.builders,
    ...
    switch (e.type) {
      case "root":
        return NF([LF(jF, n.map(function (t, r) {
          var o = e.children[r],
              a = e.children[r + 1];
          return NF([u(t), gx(o, a) ? NF([jF, "...", nx(o) ? NF([" ", n.call(u, "trailingComment")]) : ""]) : !a || nx(a.head) ? "" : NF([jF, "---"])]);
        }, "children")), 0 === e.children.length || (a = QF(e), ix(a, ["blockLiteral", "blockFolded"]) && "keep" === a.chomping) ? "" : jF]);

      case "document":
        {
          var _o72 = t.children[n.getName() + 1];
          return LF(jF, ["head" === Dx(e, _o72, t, r) ? LF(jF, [0 === e.head.children.length && 0 === e.head.endComments.length ? "" : n.call(u, "head"), NF(["---", nx(e.head) ? NF([" ", n.call(u, "head", "trailingComment")]) : ""])].filter(Boolean)) : "", mx(e) ? n.call(u, "body") : ""].filter(Boolean));
        }

      case "documentHead":
        return LF(jF, [].concat(n.map(u, "children"), n.map(u, "endComments")));

      case "documentBody":
        {
          var _t126 = LF(jF, n.map(u, "children")).parts,
          ...
          return NF([].concat(_t126, _o73, _r119));
        }

      case "directive":
        return NF(["%", LF(" ", [e.name].concat(e.parameters))]);
      ...
      case "plain":
        return Ax(e.type, r.originalText.slice(e.position.start.offset, e.position.end.offset), r);
      ...
      case "quoteSingle":
        {
          ...
          if ("quoteSingle" === e.type && _u57.includes("\\") || "quoteDouble" === e.type && /\\[^"]/.test(_u57)) {
            ...
            return NF([_o75, Ax(e.type, _u57, r), _o75]);
          }

          if (_u57.includes(_n95)) return NF([_t127, Ax(e.type, "quoteDouble" === e.type ? _u57.replace(/\\"/g, _n95).replace(/'/g, _t127.repeat(2)) : _u57, r), _t127]);
          if (_u57.includes(_t127)) return NF([_n95, Ax(e.type, "quoteSingle" === e.type ? _u57.replace(/''/g, _t127) : _u57, r), _n95]);

          var _o74 = r.singleQuote ? _t127 : _n95;

          return NF([_o74, Ax(e.type, _u57, r), _o74]);
        }

      case "blockFolded":
      case "blockLiteral":
        {
          var _t128 = HF(n, function (e) {
            return ix(e, ["sequence", "mapping"]);
          }),
              _o76 = ox(n);

          return NF(["blockFolded" === e.type ? ">" : "|", null === e.indent ? "" : e.indent.toString(), "clip" === e.chomping ? "" : "keep" === e.chomping ? "+" : "-", tx(e) ? NF([" ", n.call(u, "indicatorComment")]) : "", (null === e.indent ? OF : PF)(fx(null === e.indent ? r.tabWidth : e.indent - 1 + _t128, NF(XF(e, {
            parentIndent: _t128,
      ...
      case "sequence":
        return LF(jF, n.map(u, "children"));

      case "sequenceItem":
        return NF(["- ", fx(2, e.content ? n.call(u, "content") : "")]);
      ...
      case "flowMappingItem":
        {
          ...
          if (_o77 && _a53) return NF([": "]);

          var _s27 = n.call(u, "key"),
              _l21 = n.call(u, "value");

          if (_a53) return "flowMappingItem" === e.type && "flowMapping" === t.type ? _s27 : "mappingItem" !== e.type || !yx(e.key.content, r) || nx(e.key.content) || t.tag && "tag:yaml.org,2002:set" === t.tag.value ? NF(["? ", fx(2, _s27)]) : NF([_s27, Ex(e) ? " " : "", ":"]);
          if (_o77) return NF([": ", fx(2, _l21)]);

          var _c16 = Symbol("mappingKey");

          return ZF(e.value) || !hx(e.key.content) ? NF(["? ", fx(2, _s27), jF, LF("", n.map(u, "value", "leadingComments").map(function (e) {
            return NF([e, jF]);
          ...
          }(e.key.content) || ZF(e.key.content) || ex(e.key.content) || nx(e.key.content) || rx(e.key) || ZF(e.value.content) || ex(e.value.content) || rx(e.value) || !yx(e.value.content, r) ? TF([NF([IF(NF([MF("? "), IF(fx(2, _s27), {
            id: _c16
          })])), MF(NF([jF, ": ", fx(2, _l21)]), i(NF([Ex(e) ? " " : "", ":", ZF(e.value.content) || rx(e.value) && e.value.content && !ix(e.value.content, ["mapping", "sequence"]) || "mapping" === t.type && nx(e.key.content) && hx(e.value.content) || ix(e.value.content, ["mapping", "sequence"]) && null === e.value.content.tag && null === e.value.content.anchor ? jF : e.value.content ? RF : "", _l21])), {
            groupId: _c16
          })])]) : NF([_s27, Ex(e) ? " " : "", ": ", _l21]);
        }
      ...
      case "flowSequence":
        {
          var _t129 = "flowMapping" === e.type ? "{" : "[",
              ...
              _l22 = 0 !== e.children.length && "flowMappingItem" === (o = KF(e.children)).type && sx(o.key) && sx(o.value);

          return NF([_t129, i(NF([_s28, NF(n.map(function (t, n) {
  ...
  function bx(e, t) {
    var n = e.getValue(),
        r = e.stack[0];
    return r.isNextEmptyLinePrintedChecklist = r.isNextEmptyLinePrintedChecklist || [], r.isNextEmptyLinePrintedChecklist[n.position.end.line] || !ax(n, t) || (r.isNextEmptyLinePrintedChecklist[n.position.end.line] = !0, Cx(e.getParentNode())) ? "" : $F;
  }

  function Ax(e, t, n) {
    var r = YF(e, t, n);
    return LF(jF, r.map(function (e) {
  ...
  function Px(e) {
    ...
    return function () {
      ...
      return n[t] = Object.assign({}, r, {
        plugins: [].concat(_toConsumableArray(Ox), _toConsumableArray(Array.isArray(u) ? u : Object.values(u)))
      }), e.apply(void 0, n);
    };
  }

  var _x = Px(Ki.formatWithCursor);
  ...
  return {
    ...
    doc: dn,
    getSupportInfo: Px(Nx, 0),
    version: kx,
    util: bs,
    __debug: {
      parse: Px(Ki.parse),
      formatAST: Px(Ki.formatAST),
      formatDoc: Px(Ki.formatDoc),
      printToDoc: Px(Ki.printToDoc),
      printDocToString: Px(Ki.printDocToString)
    }
  };
});
...
},{"ev-emitter":"../node_modules/ev-emitter/ev-emitter.js"}],"utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.cursorHover = exports.cursor = exports.preloadImages = void 0;
...
var mouseText = mouse.querySelector('span');

var cursor = function cursor(e) {
...
var cursorHover = function cursorHover(e) {
  var item = e.target;

  if (item.classList.contains('nav') || item.classList.contains('logo') || item.classList.contains('fa')) {
  ...
  if (item.classList.contains('explore')) {
    ...
    _gsapCore.default.to(".about__swipe", {
      duration: 1
    }, {
      y: "0%"
    });
...
exports.cursorHover = cursorHover;
},{"gsap/gsap-core":"../node_modules/gsap/gsap-core.js","prettier":"../node_modules/prettier/standalone.js","imagesloaded":"../node_modules/imagesloaded/imagesloaded.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","utils.js"], null)
